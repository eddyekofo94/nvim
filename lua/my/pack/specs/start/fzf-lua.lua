...
return {
  ...
  data = {
    ...
    postload = function()
      ...
      ---@diagnostic disable-next-line: inject-field
      function fzf.z(opts)
        local has_z_plugin, z = pcall(require, 'my.plugin.z')
      ...
      function fzf.sessions(opts)
        local has_session_plugin, session = pcall(require, 'my.plugin.session')
      ...
      fzf.setup({
        ...
        winopts = {
          ...
          split = [[
            call v:lua.require'my.utils.win'.save_heights('_fzf_lua_win_heights') |
              \ call v:lua.require'my.utils.win'.save_views('_fzf_lua_win_views') |
