...
-- stylua: ignore start
local baby_pink = { '#f7859f' }
local black = { '#24262E' }
local black2 = { '#2a2d36' }
local blue = { '#9fd4ff' }
local cyan = { '#7fdbca' }
local dark_purple = { '#FD98B9' }
local darker_black = { '#1f2128' }
local folder_bg = { '#7fdbca' }
local green = { '#9fd54d' }
local grey = { '#4e5766' }
local grey_fg = { '#545e6e' }
local grey_fg2 = { '#5a6576' }
local lavender = { '#e4ccf4' }
local light_grey = { '#606c7e' }
local line = { '#363b46' }
local maroon = { '#dd758e' }
local nord_blue = { '#7b9cba' }
local one_bg = { '#363b46' }
local one_bg2 = { '#3c424e' }
local one_bg3 = { '#424956' }
local orange = { '#ecc48d' }
local pink = { '#f45c7f' }
local purple = { '#d9b6f0' }
local red = { '#FD98B9' }
local rosewater = { '#f895ac' }
local sapphire = { '#91d7e7' }
local statusline = { '#2a2d36' }
local sun = { '#d2dd4d' }
local teal = { '#7fdbca' }
local vibrant_green = { '#addb67' }
local white = { '#ffffff' }
local yellow = { '#becf00' }
-- stylua: ignore end
