...
-- stylua: ignore start
local baby_pink = { '#a5507c' }
local black = { '#FFFCF0' }
local black2 = { '#f2efe4' }
local blue = { '#4385BE' }
local cyan = { '#3AA99F' }
local dark_purple = { '#8376bc' }
...
local lavender = { '#6e6498' }
local light_grey = { '#94928b' }
local line = { '#d6d4ca' }
local maroon = { '#a56492' }
local nord_blue = { '#789bb6' }
local one_bg = { '#ebe8dd' }
...
local purple = { '#8B7EC8' }
local red = { '#D14D41' }
local rosewater = { '#954b70' }
local sapphire = { '#2583a2' }
local statusline = { '#f7f4e9' }
local sun = { '#9e7e1b' }
local teal = { '#008080' }
local vibrant_green = { '#66800B' }
local white = { '#2a2929' }
local yellow = { '#D0A215' }
-- stylua: ignore end
