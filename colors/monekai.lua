...
-- stylua: ignore start
local baby_pink = { '#f48f95' }
local black = { '#272822' }
local black2 = { '#2F302A' }
local blue = { '#51afef' }
local cyan = { '#41afef' }
local dark_purple = { '#b26fc1' }
local darker_black = { '#22231D' }
local folder_bg = { '#61afef' }
local green = { '#96c367' }
local grey = { '#4D4E48' }
local grey_fg = { '#555650' }
local grey_fg2 = { '#5D5E58' }
local lavender = { '#d6a6df' }
local light_grey = { '#64655F' }
local line = { '#363942' }
local maroon = { '#cd7d88' }
local nord_blue = { '#4f83a4' }
local one_bg = { '#363731' }
local one_bg2 = { '#3E3F39' }
local one_bg3 = { '#464741' }
local orange = { '#d39467' }
local pink = { '#f36d76' }
local purple = { '#c885d7' }
local red = { '#e36d76' }
local rosewater = { '#f49ca1' }
local sapphire = { '#44b6e1' }
local statusline = { '#2F302A' }
local sun = { '#ead0a3' }
local teal = { '#34bfd0' }
local vibrant_green = { '#99c366' }
local white = { '#f5f4f1' }
local yellow = { '#e6c181' }
-- stylua: ignore end
