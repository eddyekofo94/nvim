...
-- stylua: ignore start
local baby_pink = { '#f1869f' }
local black = { '#1e2122' }
local black2 = { '#242728' }
local blue = { '#6d8dad' }
local cyan = { '#82b3a8' }
local dark_purple = { '#887aa9' }
local darker_black = { '#1a1d1e' }
local folder_bg = { '#6d8dad' }
local green = { '#89b482' }
local grey = { '#484b4c' }
local grey_fg = { '#575a5b' }
local grey_fg2 = { '#545758' }
local lavender = { '#a394ad' }
local light_grey = { '#606364' }
local line = { '#323536' }
local maroon = { '#e37c9b' }
local nord_blue = { '#5c6f81' }
local one_bg = { '#282b2c' }
local one_bg2 = { '#393c3d' }
local one_bg3 = { '#404344' }
local orange = { '#e78a4e' }
local pink = { '#ff75a0' }
local purple = { '#9385b4' }
local red = { '#ec6b64' }
local rosewater = { '#eb8c9f' }
local sapphire = { '#70919d' }
local statusline = { '#222526' }
local sun = { '#d2b782' }
local teal = { '#749689' }
local vibrant_green = { '#a9b665' }
local white = { '#c7b89d' }
local yellow = { '#d6b676' }
-- stylua: ignore end
