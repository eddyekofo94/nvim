...
vim.cmd.hi('clear')
vim.g.colors_name = 'midnight_breeze'

-- stylua: ignore start
local baby_pink = { '#f2bab4' }
local black = { '#0d1117' }
local black2 = { '#121619' }
local blue = { '#58a6ff' }
local cyan = { '#39c5cf' }
local dark_purple = { '#a259ff' }
local darker_black = { '#070a0d' }
local folder_bg = { '#6e7681' }
local green = { '#56d364' }
local grey = { '#313641' }
local grey_fg = { '#434b59' }
local grey_fg2 = { '#4f5969' }
local lavender = { '#c0a1f4' }
local light_grey = { '#8b949e' }
local line = { '#21262d' }
local maroon = { '#d7b7b0' }
local nord_blue = { '#4674aa' }
local one_bg = { '#161b22' }
local one_bg2 = { '#1b2128' }
local one_bg3 = { '#21262d' }
local orange = { '#ffab70' }
local pink = { '#ffb3a8' }
local purple = { '#bc8cff' }
local red = { '#fb6f6f' }
local rosewater = { '#ecbeb9' }
local sapphire = { '#4ab4e9' }
local statusline = { '#161b22' }
local sun = { '#efdb82' }
local teal = { '#39c5cf' }
local vibrant_green = { '#57d27d' }
local white = { '#c9d1d9' }
local yellow = { '#ffdf5d' }
-- stylua: ignore end
