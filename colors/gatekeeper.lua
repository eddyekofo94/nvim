...
-- stylua: ignore start
local baby_pink = { '#f28cb2' }
local black = { '#101010' }
local black2 = { '#181818' }
local blue = { '#29adff' }
local cyan = { '#29adff' }
local dark_purple = { '#998cb2' }
local darker_black = { '#0a0a0a' }
local folder_bg = { '#29adff' }
local green = { '#00e756' }
local grey = { '#363636' }
local grey_fg = { '#3d3d3d' }
local grey_fg2 = { '#454545' }
local lavender = { '#b2a9c5' }
local light_grey = { '#4d4d4d' }
local line = { '#2c2c2c' }
local maroon = { '#ce7c99' }
local nord_blue = { '#2f77a5' }
local one_bg = { '#1e1e1e' }
local one_bg2 = { '#252525' }
local one_bg3 = { '#2c2c2c' }
local orange = { '#ffa300' }
local pink = { '#ff77a8' }
local purple = { '#a79ac0' }
local red = { '#ff1a67' }
local rosewater = { '#ed95b6' }
local sapphire = { '#1ca1b6' }
local statusline = { '#181818' }
local sun = { '#f0e658' }
local teal = { '#0b925c' }
local vibrant_green = { '#10f766' }
local white = { '#cccdd1' }
local yellow = { '#fff024' }
-- stylua: ignore end
