...
-- stylua: ignore start
local baby_pink = { '#8a1216' }
local black = { '#F2E5BC' }
local black2 = { '#e3d6ad' }
local blue = { '#458588' }
local cyan = { '#82b3a8' }
local dark_purple = { '#853567' }
local darker_black = { '#e8dbb2' }
local folder_bg = { '#746d69' }
local green = { '#79740e' }
local grey = { '#c0b38a' }
local grey_fg = { '#b6a980' }
local grey_fg2 = { '#ac9f76' }
local lavender = { '#7c4264' }
local light_grey = { '#a2956c' }
local line = { '#ded1a8' }
local maroon = { '#951e20' }
local nord_blue = { '#7c9a89' }
local one_bg = { '#e5d8af' }
local one_bg2 = { '#d8cba2' }
local one_bg3 = { '#cabd94' }
local orange = { '#b57614' }
local pink = { '#9d0006' }
local purple = { '#8f3f71' }
local red = { '#d65d0e' }
local rosewater = { '#821a1c' }
local sapphire = { '#5a8d88' }
local statusline = { '#e9dcb3' }
local sun = { '#ae812c' }
local teal = { '#749689' }
local vibrant_green = { '#7f7a14' }
local white = { '#504945' }
local yellow = { '#d79921' }
-- stylua: ignore end
