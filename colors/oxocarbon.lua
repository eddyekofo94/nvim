...
local lavender = { '#dac0eb' }
local light_grey = { '#5f5f5f' }
local line = { '#383747' }
local maroon = { '#bca6f9' }
local nord_blue = { '#3c81ac' }
local one_bg = { '#2a2a2a' }
local one_bg2 = { '#343434' }
local one_bg3 = { '#3c3c3c' }
local orange = { '#F8BD96' }
local pink = { '#be95ff' }
local purple = { '#d0a9e5' }
local red = { '#ee5396' }
local rosewater = { '#d0b6fd' }
local sapphire = { '#6dcaf1' }
local statusline = { '#202020' }
local sun = { '#f8e8c6' }
local teal = { '#B5E8E0' }
