...
-- stylua: ignore start
local baby_pink = { '#df94d7' }
local black = { '#212121' }
local black2 = { '#292929' }
local blue = { '#82aaff' }
local cyan = { '#89ddff' }
local dark_purple = { '#b480d6' }
local darker_black = { '#191919' }
local folder_bg = { '#6e98eb' }
local green = { '#c3e88d' }
local grey = { '#4A4A4A' }
local grey_fg = { '#545454' }
local grey_fg2 = { '#5E5E5E' }
local lavender = { '#d3b3f0' }
local light_grey = { '#6B6B6B' }
local line = { '#383838' }
local maroon = { '#d183b9' }
local nord_blue = { '#697fae' }
local one_bg = { '#303030' }
local one_bg2 = { '#383838' }
local one_bg3 = { '#404040' }
local orange = { '#f78c6c' }
local pink = { '#DA70CA' }
local purple = { '#c792ea' }
local red = { '#f07178' }
local rosewater = { '#e1a2dd' }
local sapphire = { '#94bbc1' }
local statusline = { '#262626' }
local sun = { '#fadb97' }
local teal = { '#abcf76' }
local vibrant_green = { '#c3e88d' }
local white = { '#eeffff' }
local yellow = { '#ffcb6b' }
-- stylua: ignore end
