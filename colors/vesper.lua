...
-- stylua: ignore start
local baby_pink = { '#fcc2ff' }
local black = { '#101010' }
local black2 = { '#1C1C1C' }
local blue = { '#FFC799' }
local cyan = { '#99FFE4' }
local dark_purple = { '#FBADFF' }
local darker_black = { '#0a0a0a' }
local folder_bg = { '#FFC799' }
local green = { '#99FFE4' }
local grey = { '#505050' }
local grey_fg = { '#595959' }
local grey_fg2 = { '#6e6e6e' }
local lavender = { '#fcc6ff' }
local light_grey = { '#7E7E7E' }
local line = { '#282828' }
local maroon = { '#e7bdfa' }
local nord_blue = { '#b09178' }
local one_bg = { '#232323' }
local one_bg2 = { '#282828' }
local one_bg3 = { '#343434' }
local orange = { '#FFC799' }
local pink = { '#FBADFF' }
local purple = { '#FBADFF' }
local red = { '#FF8080' }
local rosewater = { '#fccaff' }
local sapphire = { '#d1e0bb' }
local statusline = { '#1C1C1C' }
local sun = { '#ffd8b8' }
local teal = { '#99FFE4' }
local vibrant_green = { '#99FFE4' }
local white = { '#FFFFFF' }
local yellow = { '#FFC799' }
-- stylua: ignore end
