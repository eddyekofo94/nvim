...
-- stylua: ignore start
local baby_pink = { '#fabed0' }
local black = { '#1B1F23' }
local black2 = { '#22262a' }
local blue = { '#A3CBE7' }
local cyan = { '#C9D4FF' }
local dark_purple = { '#B1A8FB' }
local darker_black = { '#161a1e' }
local folder_bg = { '#A3CBE7' }
local green = { '#B4E3AD' }
local grey = { '#43474b' }
local grey_fg = { '#4b4f53' }
local grey_fg2 = { '#54585c' }
local lavender = { '#ddbbe5' }
local light_grey = { '#5d6165' }
local line = { '#343A40' }
local maroon = { '#e4b9cd' }
local nord_blue = { '#7890a1' }
local one_bg = { '#25292d' }
local one_bg2 = { '#2f3337' }
local one_bg3 = { '#393d41' }
local orange = { '#F1C192' }
local pink = { '#F8B3CC' }
local purple = { '#CEACE8' }
local red = { '#e5a3a1' }
local rosewater = { '#fac2d2' }
local sapphire = { '#9ccedc' }
local statusline = { '#22262a' }
local sun = { '#f2e2be' }
local teal = { '#94D2CF' }
local vibrant_green = { '#9EDABE' }
local white = { '#FFDEDE' }
local yellow = { '#ECE3B1' }
-- stylua: ignore end
