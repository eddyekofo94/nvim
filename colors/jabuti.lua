...
-- stylua: ignore start
local baby_pink = { '#f696c4' }
local black = { '#292A37' }
local black2 = { '#2e2f3e' }
local blue = { '#78a9ff' }
local cyan = { '#6be6e6' }
local dark_purple = { '#936FDC' }
local darker_black = { '#272734' }
local folder_bg = { '#78a9ff' }
local green = { '#3FDAA4' }
local grey = { '#50526b' }
local grey_fg = { '#555772' }
local grey_fg2 = { '#606281' }
local lavender = { '#c6acfa' }
local light_grey = { '#67698a' }
local line = { '#383747' }
local maroon = { '#ce91bd' }
local nord_blue = { '#6682bc' }
local one_bg = { '#343545' }
local one_bg2 = { '#3c3e51' }
local one_bg3 = { '#45475d' }
local orange = { '#efb993' }
local pink = { '#ff7eb6' }
local purple = { '#be95ff' }
local red = { '#ec6a88' }
local rosewater = { '#f2a0ca' }
local sapphire = { '#46c1ee' }
local statusline = { '#2e2f3e' }
local sun = { '#dfceb1' }
local teal = { '#09deda' }
local vibrant_green = { '#08bdba' }
local white = { '#d9e0ee' }
local yellow = { '#e1c697' }
-- stylua: ignore end
