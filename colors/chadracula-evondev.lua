...
-- stylua: ignore start
local baby_pink = { '#fd8ed5' }
local black = { '#141423' }
local black2 = { '#1c1c31' }
local blue = { '#2CCCFF' }
local cyan = { '#2CCCFF' }
local dark_purple = { '#a166f6' }
local darker_black = { '#19192c' }
local folder_bg = { '#9A86FD' }
local green = { '#50FA7B' }
local grey = { '#414171' }
local grey_fg = { '#4b4b83' }
local grey_fg2 = { '#555594' }
local lavender = { '#cfb1f7' }
local light_grey = { '#6060a4' }
local line = { '#2D2D4E' }
local maroon = { '#e976cd' }
local nord_blue = { '#358dbf' }
local one_bg = { '#23233d' }
local one_bg2 = { '#2b2b4c' }
local one_bg3 = { '#373760' }
local orange = { '#FFB86C' }
local pink = { '#FF6BCB' }
local purple = { '#BD93F9' }
local red = { '#FF5555' }
local rosewater = { '#fd9cd9' }
local sapphire = { '#5ab9ec' }
local statusline = { '#19192c' }
local sun = { '#f3f9ab' }
local teal = { '#92A2D4' }
local vibrant_green = { '#20E3B2' }
local white = { '#F8F8F2' }
local yellow = { '#F1FA8C' }
-- stylua: ignore end
