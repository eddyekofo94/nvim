...
-- stylua: ignore start
local baby_pink = { '#bf5d58' }
local black = { '#fdf6e3' }
local black2 = { '#ede7d3' }
local blue = { '#268bd2' }
local cyan = { '#2aa198' }
local dark_purple = { '#6c71c4' }
local darker_black = { '#ede7d3' }
local folder_bg = { '#268bd2' }
local green = { '#859900' }
local grey = { '#c4b8aa' }
local grey_fg = { '#b6a99b' }
local grey_fg2 = { '#a89b8d' }
local lavender = { '#4c5c99' }
local light_grey = { '#9b8e80' }
local line = { '#e0dbc3' }
local maroon = { '#d4786e' }
local nord_blue = { '#6d9fc0' }
local one_bg = { '#e8dfc9' }
local one_bg2 = { '#e4ddc4' }
local one_bg3 = { '#ddd6be' }
local orange = { '#cb4b16' }
local pink = { '#ff6e64' }
local purple = { '#6c71c4' }
local red = { '#dc322f' }
local rosewater = { '#a65754' }
local sapphire = { '#2895b8' }
local statusline = { '#f1ecdd' }
local sun = { '#7f6d10' }
local teal = { '#2aa198' }
local vibrant_green = { '#b58900' }
local white = { '#002b36' }
local yellow = { '#b58900' }
-- stylua: ignore end
