...
-- stylua: ignore start
local baby_pink = { '#e85094' }
local black = { '#201947' }
local black2 = { '#271e56' }
local blue = { '#268bd2' }
local cyan = { '#37dcf6' }
local dark_purple = { '#322880' }
local darker_black = { '#1d1741' }
local folder_bg = { '#268bd2' }
local green = { '#859900' }
local grey = { '#423494' }
local grey_fg = { '#4c3ca9' }
local grey_fg2 = { '#5442bb' }
local lavender = { '#a097cf' }
local light_grey = { '#6d5dc6' }
local line = { '#2b215f' }
local maroon = { '#cf3f87' }
local nord_blue = { '#3364b6' }
local one_bg = { '#2e2466' }
local one_bg2 = { '#352975' }
local one_bg3 = { '#3e318a' }
local orange = { '#c85106' }
local pink = { '#e61d7e' }
local purple = { '#7E74CC' }
local red = { '#ff047d' }
local rosewater = { '#e9649c' }
local sapphire = { '#49a5c0' }
local statusline = { '#271e56' }
local sun = { '#c6a640' }
local teal = { '#74c5aa' }
