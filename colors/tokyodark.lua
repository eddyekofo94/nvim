...
-- stylua: ignore start
local baby_pink = { '#e67c97' }
local black = { '#11121D' }
local black2 = { '#171823' }
local blue = { '#7199ee' }
local cyan = { '#38a89d' }
local dark_purple = { '#9071c9' }
local darker_black = { '#0c0d18' }
local folder_bg = { '#7199ee' }
local green = { '#98c379' }
local grey = { '#474853' }
local grey_fg = { '#474853' }
local grey_fg2 = { '#4e4f5a' }
local lavender = { '#a390d8' }
local light_grey = { '#545560' }
local line = { '#252631' }
local maroon = { '#db7690' }
local nord_blue = { '#5e75a8' }
local one_bg = { '#1d1e29' }
local one_bg2 = { '#252631' }
local one_bg3 = { '#252631' }
local orange = { '#f6955b' }
local pink = { '#fe6D85' }
local purple = { '#a485dd' }
local red = { '#ee6d85' }
local rosewater = { '#dd829e' }
local sapphire = { '#6399d7' }
local statusline = { '#161722' }
local sun = { '#c6a780' }
local teal = { '#519aba' }
local vibrant_green = { '#95c561' }
local white = { '#A0A8CD' }
local yellow = { '#d7a65f' }
-- stylua: ignore end
