...
-- stylua: ignore start
local baby_pink = { '#a599a3' }
local black = { '#181616' }
local black2 = { '#1f1d1d' }
local blue = { '#8ba4b0' }
local cyan = { '#8ea4a2' }
local dark_purple = { '#8992a7' }
local darker_black = { '#100e0e' }
local folder_bg = { '#87a987' }
local green = { '#8a9a7b' }
local grey = { '#424040' }
local grey_fg = { '#504e4e' }
local grey_fg2 = { '#575555' }
local lavender = { '#a59aa3' }
local light_grey = { '#5e5c5c' }
local line = { '#282727' }
local maroon = { '#9f95a7' }
local nord_blue = { '#6a777e' }
local one_bg = { '#262424' }
local one_bg2 = { '#2d2b2b' }
local one_bg3 = { '#343232' }
local orange = { '#b6927b' }
local pink = { '#a292a3' }
local purple = { '#a292a3' }
local red = { '#c4746e' }
local rosewater = { '#a69ba3' }
local sapphire = { '#8fa2b2' }
local statusline = { '#1f1d1d' }
local sun = { '#bdb092' }
local teal = { '#949fb5' }
local vibrant_green = { '#8a9a7b' }
local white = { '#adada4' }
local yellow = { '#c4b28a' }
-- stylua: ignore end
