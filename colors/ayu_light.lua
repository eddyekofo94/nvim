...
local blue = { '#399EE6' }
local cyan = { '#95E6CB' }
local dark_purple = { '#8627e6' }
local darker_black = { '#f3f3f3' }
local folder_bg = { '#5C6166' }
local green = { '#6CBF43' }
local grey = { '#cdcdcd' }
local grey_fg = { '#b9b9b9' }
local grey_fg2 = { '#acacac' }
local lavender = { '#7b39c1' }
local light_grey = { '#a0a0a0' }
local line = { '#e1e1e1' }
local maroon = { '#e3aba6' }
local nord_blue = { '#7cb3db' }
local one_bg = { '#ebebeb' }
...
local sapphire = { '#54b0cb' }
local statusline = { '#f0f0f0' }
local sun = { '#ac8e66' }
local teal = { '#74c5aa' }
local vibrant_green = { '#94e76b' }
local white = { '#26292f' }
local yellow = { '#E6BA7E' }
-- stylua: ignore end
