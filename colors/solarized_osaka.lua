...
-- stylua: ignore start
local baby_pink = { '#8a9e2b' }
local black = { '#011219' }
local black2 = { '#02202D' }
local blue = { '#268bd3' }
local cyan = { '#2aa198' }
local dark_purple = { '#B02669' }
local darker_black = { '#011923' }
local folder_bg = { '#268bd3' }
local green = { '#849900' }
local grey = { '#405055' }
local grey_fg = { '#47585E' }
local grey_fg2 = { '#4F6369' }
local lavender = { '#4ca59e' }
local light_grey = { '#586E75' }
local line = { '#022736' }
local maroon = { '#7a9925' }
local nord_blue = { '#32709a' }
local one_bg = { '#022736' }
local one_bg2 = { '#03394F' }
local one_bg3 = { '#044A67' }
local orange = { '#C84C16' }
local pink = { '#849900' }
local purple = { '#29a298' }
local red = { '#db302d' }
local rosewater = { '#8d9f3c' }
local sapphire = { '#3992c8' }
local statusline = { '#02202D' }
local sun = { '#ac9034' }
local teal = { '#519ABA' }
local vibrant_green = { '#bad600' }
local white = { '#9eabac' }
local yellow = { '#b28500' }
-- stylua: ignore end
