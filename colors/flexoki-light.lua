...
-- stylua: ignore start
local baby_pink = { '#822e5e' }
local black = { '#FFFCF0' }
local black2 = { '#f2efe4' }
local blue = { '#205EA6' }
local cyan = { '#24837B' }
local dark_purple = { '#5E409D' }
local darker_black = { '#f7f4e9' }
local folder_bg = { '#6F6E69' }
local green = { '#66800B' }
local grey = { '#b8b5ad' }
local grey_fg = { '#adaba3' }
local grey_fg2 = { '#a3a19a' }
local lavender = { '#685393' }
local light_grey = { '#94928b' }
local line = { '#d6d4ca' }
local maroon = { '#90447e' }
local nord_blue = { '#6485a9' }
local one_bg = { '#ebe8dd' }
local one_bg2 = { '#d6d4ca' }
local one_bg3 = { '#c7c5bb' }
local orange = { '#BC5215' }
local pink = { '#A02F6F' }
local purple = { '#8265c0' }
local red = { '#AF3029' }
local rosewater = { '#772d56' }
local sapphire = { '#3679af' }
local statusline = { '#f7f4e9' }
local sun = { '#86680d' }
local teal = { '#519ABA' }
local vibrant_green = { '#879A39' }
local white = { '#2a2929' }
local yellow = { '#AD8301' }
-- stylua: ignore end
