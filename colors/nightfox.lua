...
-- stylua: ignore start
local baby_pink = { '#d57a91' }
local black = { '#192330' }
local black2 = { '#202a37' }
local blue = { '#719cd6' }
local cyan = { '#8be5e7' }
local dark_purple = { '#9d79d6' }
local darker_black = { '#121c29' }
local folder_bg = { '#719cd6' }
local green = { '#8ebaa4' }
local grey = { '#495360' }
local grey_fg = { '#535d6a' }
local grey_fg2 = { '#5c6673' }
local lavender = { '#c0aedc' }
local light_grey = { '#646e7b' }
local line = { '#2a3441' }
local maroon = { '#bf738b' }
local nord_blue = { '#5f7ba1' }
local one_bg = { '#252f3c' }
local one_bg2 = { '#313b48' }
local one_bg3 = { '#3d4754' }
local orange = { '#fe9373' }
local pink = { '#d85e7c' }
local purple = { '#baa1e2' }
local red = { '#c94f6d' }
local rosewater = { '#d48599' }
local sapphire = { '#68afd0' }
local statusline = { '#202a37' }
local sun = { '#d7c48f' }
local teal = { '#5cc6c8' }
local vibrant_green = { '#6ad4d6' }
local white = { '#cdcecf' }
local yellow = { '#dbc074' }
-- stylua: ignore end
