...
-- stylua: ignore start
local baby_pink = { '#fdc1c9' }
local black = { '#020222' }
local black2 = { '#1A1A3A' }
local blue = { '#6699cc' }
local cyan = { '#BFDAFF' }
local dark_purple = { '#635196' }
local darker_black = { '#0c0c2d' }
local folder_bg = { '#598cbf' }
local green = { '#9BCCBF' }
local grey = { '#393959' }
local grey_fg = { '#434363' }
local grey_fg2 = { '#4d4d6d' }
local lavender = { '#b6bdd0' }
local light_grey = { '#5c5c7c' }
local line = { '#202040' }
local maroon = { '#d6b2b3' }
local nord_blue = { '#526e98' }
local one_bg = { '#161636' }
local one_bg2 = { '#202040' }
local one_bg3 = { '#2a2a4a' }
local orange = { '#f99157' }
local pink = { '#ffafb7' }
local purple = { '#99A4BC' }
local red = { '#FF761A' }
local rosewater = { '#fdc9d0' }
local sapphire = { '#50aaba' }
local statusline = { '#0b0b2b' }
local sun = { '#fdd486' }
local teal = { '#34BFA4' }
