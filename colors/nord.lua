...
-- stylua: ignore start
local baby_pink = { '#ca8690' }
local black = { '#2E3440' }
local black2 = { '#343a46' }
local blue = { '#7797b7' }
local cyan = { '#9aafe6' }
local dark_purple = { '#a983a2' }
local darker_black = { '#2a303c' }
local folder_bg = { '#7797b7' }
local green = { '#A3BE8C' }
local grey = { '#4b515d' }
local grey_fg = { '#565c68' }
local grey_fg2 = { '#606672' }
local lavender = { '#b199b2' }
local light_grey = { '#646a76' }
local line = { '#414753' }
local maroon = { '#be7a87' }
local nord_blue = { '#63788e' }
local one_bg = { '#373d49' }
local one_bg2 = { '#464c58' }
local one_bg3 = { '#494f5b' }
local orange = { '#e39a83' }
local pink = { '#d57780' }
local purple = { '#B48EAD' }
local red = { '#BF616A' }
local rosewater = { '#c68c96' }
