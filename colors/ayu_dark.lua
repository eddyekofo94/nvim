...
-- stylua: ignore start
local baby_pink = { '#f3959d' }
local black = { '#0B0E14' }
local black2 = { '#14171d' }
local blue = { '#36A3D9' }
local cyan = { '#95E6CB' }
local dark_purple = { '#A37ACC' }
local darker_black = { '#05080e' }
local folder_bg = { '#98a3af' }
local green = { '#AAD84C' }
local grey = { '#33363c' }
local grey_fg = { '#3d4046' }
local grey_fg2 = { '#46494f' }
local lavender = { '#c9acee' }
local light_grey = { '#54575d' }
local line = { '#24272d' }
local maroon = { '#e38e8e' }
local nord_blue = { '#357292' }
local one_bg = { '#1c1f25' }
local one_bg2 = { '#24272d' }
local one_bg3 = { '#2b2e34' }
local orange = { '#ffa455' }
local pink = { '#ff8087' }
local purple = { '#c79bf4' }
local red = { '#F07178' }
local rosewater = { '#ee9da6' }
local sapphire = { '#52b2c4' }
local statusline = { '#12151b' }
local sun = { '#e0ca75' }
local teal = { '#74c5aa' }
