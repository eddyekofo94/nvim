...
-- stylua: ignore start
local baby_pink = { '#c9a9ea' }
local black = { '#171B20' }
local black2 = { '#1e2227' }
local blue = { '#86aaec' }
local cyan = { '#98d3ee' }
local dark_purple = { '#b77bdf' }
local darker_black = { '#111519' }
local folder_bg = { '#78DBA9' }
local green = { '#78DBA9' }
local grey = { '#41454a' }
local grey_fg = { '#494d52' }
local grey_fg2 = { '#505459' }
local lavender = { '#cda4ec' }
local light_grey = { '#5a5e63' }
local line = { '#282d35' }
local maroon = { '#b4a4e3' }
local nord_blue = { '#677da3' }
local one_bg = { '#262a2f' }
local one_bg2 = { '#2f3338' }
local one_bg3 = { '#373b40' }
local orange = { '#e9a180' }
local pink = { '#c296eb' }
local purple = { '#c68aee' }
local red = { '#e26c7c' }
local rosewater = { '#ccb0e9' }
local sapphire = { '#82c0da' }
local statusline = { '#1c2026' }
local sun = { '#e8d7b5' }
local teal = { '#7ddac5' }
local vibrant_green = { '#87eab8' }
local white = { '#dee1e6' }
local yellow = { '#ecd3a0' }
-- stylua: ignore end
