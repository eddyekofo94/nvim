...
-- stylua: ignore start
local baby_pink = { '#fa8ea4' }
local black = { '#282828' }
local black2 = { '#2e2e2e' }
local blue = { '#458588' }
local cyan = { '#82b3a8' }
local dark_purple = { '#d3869b' }
local darker_black = { '#232323' }
local folder_bg = { '#749689' }
local green = { '#b8bb26' }
local grey = { '#4b4b4b' }
local grey_fg = { '#4e4e4e' }
local grey_fg2 = { '#505050' }
local lavender = { '#c4c5c1' }
local light_grey = { '#656565' }
local line = { '#36393a' }
local maroon = { '#e37c9b' }
local nord_blue = { '#486b6d' }
local one_bg = { '#353535' }
local one_bg2 = { '#3f3f3f' }
local one_bg3 = { '#444444' }
local orange = { '#e78a4e' }
local pink = { '#ff75a0' }
local purple = { '#b4bbc8' }
local red = { '#fb4934' }
local rosewater = { '#f899a6' }
