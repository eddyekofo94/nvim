...
-- stylua: ignore start
local baby_pink = { '#ca5cbf' }
local black = { '#06101E' }
local black2 = { '#0a1c36' }
local blue = { '#35b5ff' }
local cyan = { '#66def9' }
local dark_purple = { '#722529' }
local darker_black = { '#071426' }
local folder_bg = { '#35b5ff' }
local green = { '#01eca7' }
local grey = { '#123466' }
local grey_fg = { '#164080' }
local grey_fg2 = { '#184686' }
local lavender = { '#c464c3' }
local light_grey = { '#184686' }
local line = { '#0e284e' }
local maroon = { '#d153bb' }
local nord_blue = { '#257bba' }
local one_bg = { '#0c2242' }
local one_bg2 = { '#0e284e' }
local one_bg3 = { '#102e5a' }
local orange = { '#fd5e3a' }
local pink = { '#ec30ac' }
local purple = { '#ec30ac' }
local red = { '#fc9487' }
local rosewater = { '#bd6dc7' }
local sapphire = { '#4bc7fc' }
local statusline = { '#0a1c36' }
local sun = { '#d08473' }
local teal = { '#66def9' }
local vibrant_green = { '#5f6e29' }
local white = { '#66def9' }
local yellow = { '#fd5e3a' }
-- stylua: ignore end
