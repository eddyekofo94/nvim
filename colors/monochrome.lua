...
-- stylua: ignore start
local baby_pink = { '#da9aa2' }
local black = { '#101010' }
local black2 = { '#202020' }
local blue = { '#8abae1' }
local cyan = { '#9aafe6' }
local dark_purple = { '#db9fe9' }
local darker_black = { '#1a1a1a' }
local folder_bg = { '#7797b7' }
local green = { '#c9d36a' }
local grey = { '#424242' }
local grey_fg = { '#4c4c4c' }
local grey_fg2 = { '#606060' }
local lavender = { '#dec8e9' }
local light_grey = { '#677777' }
local line = { '#2e2e2e' }
local maroon = { '#c28390' }
local nord_blue = { '#6a8499' }
local one_bg = { '#242424' }
local one_bg2 = { '#2e2e2e' }
local one_bg3 = { '#383838' }
local orange = { '#efb6a0' }
local pink = { '#da838b' }
local purple = { '#e1bee9' }
local red = { '#ec8989' }
local rosewater = { '#d9a3ac' }
local sapphire = { '#79a2c6' }
local statusline = { '#1e1e1e' }
local sun = { '#f3e4c5' }
local teal = { '#6484a4' }
local vibrant_green = { '#eff6ab' }
local white = { '#D8DEE9' }
local yellow = { '#ffe6b5' }
-- stylua: ignore end
