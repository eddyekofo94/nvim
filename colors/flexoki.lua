...
-- stylua: ignore start
local baby_pink = { '#ce79a2' }
local black = { '#100F0F' }
local black2 = { '#1c1b1b' }
local blue = { '#4385BE' }
local cyan = { '#3AA99F' }
local dark_purple = { '#7f70c2' }
local darker_black = { '#171616' }
local folder_bg = { '#4385BE' }
local green = { '#879A39' }
local grey = { '#393636' }
local grey_fg = { '#555050' }
local grey_fg2 = { '#5f5959' }
local lavender = { '#9f96c6' }
local light_grey = { '#6a6363' }
local line = { '#292626' }
local maroon = { '#b5699e' }
local nord_blue = { '#3e6181' }
local one_bg = { '#292626' }
local one_bg2 = { '#353232' }
local one_bg3 = { '#373434' }
local orange = { '#DA702C' }
local pink = { '#CE5D97' }
local purple = { '#8B7EC8' }
local red = { '#D14D41' }
local rosewater = { '#ce84a6' }
local sapphire = { '#498ebc' }
local statusline = { '#171616' }
local sun = { '#cfaf49' }
local teal = { '#519ABA' }
local vibrant_green = { '#7e9f0e' }
local white = { '#CECDC3' }
local yellow = { '#D0A215' }
-- stylua: ignore end
