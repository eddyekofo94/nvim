...
-- stylua: ignore start
local baby_pink = { '#d0546c' }
local black = { '#fafafa' }
local black2 = { '#EBEBEB' }
local blue = { '#6182b8' }
local cyan = { '#39adb5' }
local dark_purple = { '#9671ff' }
local darker_black = { '#F2F2F2' }
local folder_bg = { '#6e98eb' }
local green = { '#91b859' }
local grey = { '#C4C4C4' }
local grey_fg = { '#C4C4C4' }
local grey_fg2 = { '#BDBDBD' }
local lavender = { '#6b50d0' }
local light_grey = { '#B3B3B3' }
local line = { '#EBEBEB' }
local maroon = { '#d7657e' }
local nord_blue = { '#8ea0bd' }
local one_bg = { '#EBEBEB' }
local one_bg2 = { '#E1E1E1' }
local one_bg3 = { '#D9D9D9' }
local orange = { '#f76d47' }
local pink = { '#FF5370' }
local purple = { '#7c4dff' }
local red = { '#e53935' }
local rosewater = { '#bd556b' }
local sapphire = { '#4f95b7' }
local statusline = { '#F2F2F2' }
local sun = { '#c0842e' }
local teal = { '#39ADB5' }
local vibrant_green = { '#a7c67a' }
local white = { '#435862' }
local yellow = { '#F59717' }
-- stylua: ignore end
