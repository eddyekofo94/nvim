...
-- stylua: ignore start
local baby_pink = { '#eeb2c5' }
local black = { '#151515' }
local black2 = { '#1c1c1c' }
local blue = { '#8197bf' }
local cyan = { '#8fbfdc' }
local dark_purple = { '#e58fe5' }
local darker_black = { '#101010' }
local folder_bg = { '#8197bf' }
local green = { '#99ad6a' }
local grey = { '#424242' }
local grey_fg = { '#474747' }
local grey_fg2 = { '#4c4c4c' }
local lavender = { '#e9ade3' }
local light_grey = { '#525252' }
local line = { '#2d2d2d' }
local maroon = { '#d49bb8' }
local nord_blue = { '#657187' }
local one_bg = { '#252525' }
local one_bg2 = { '#2e2e2e' }
local one_bg3 = { '#3a3a3a' }
local orange = { '#e78a4e' }
local pink = { '#f0a0c0' }
local purple = { '#ea94ea' }
local red = { '#cf6a4c' }
local rosewater = { '#edb9c7' }
local sapphire = { '#7590ae' }
local statusline = { '#191919' }
local sun = { '#f5d795' }
local teal = { '#668799' }
local vibrant_green = { '#c2cea6' }
local white = { '#e8e8d3' }
local yellow = { '#fad07a' }
-- stylua: ignore end
