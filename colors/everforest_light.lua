...
-- stylua: ignore start
local baby_pink = { '#bd5879' }
local black = { '#fff9e8' }
local black2 = { '#F0EAD9' }
local blue = { '#3a94c5' }
local cyan = { '#89bfdc' }
local dark_purple = { '#966986' }
local darker_black = { '#f5efde' }
local folder_bg = { '#747b6e' }
local green = { '#5da111' }
local grey = { '#B3AD9C' }
local grey_fg = { '#A39D8C' }
local grey_fg2 = { '#948E7D' }
local lavender = { '#8b6379' }
local light_grey = { '#857F6E' }
local line = { '#e8e2d1' }
local maroon = { '#d47293' }
local nord_blue = { '#709fb3' }
local one_bg = { '#E0DAC9' }
local one_bg2 = { '#D1CBBA' }
local one_bg3 = { '#C2BCAB' }
local orange = { '#F7954F' }
local pink = { '#ef6590' }
local purple = { '#b67996' }
local red = { '#c85552' }
local rosewater = { '#a95270' }
local sapphire = { '#4f9cb3' }
local statusline = { '#ede7d6' }
local sun = { '#a87e10' }
local teal = { '#69a59d' }
local vibrant_green = { '#87a060' }
local white = { '#272f35' }
local yellow = { '#dfa000' }
-- stylua: ignore end
