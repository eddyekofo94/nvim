...
-- stylua: ignore start
local baby_pink = { '#e9acdc' }
local black = { '#141b1e' }
local black2 = { '#1a2124' }
local blue = { '#67b0e8' }
local cyan = { '#6cbfbf' }
local dark_purple = { '#b570c6' }
local darker_black = { '#10171a' }
local folder_bg = { '#71baf2' }
local green = { '#8ccf7e' }
local grey = { '#3c4346' }
local grey_fg = { '#464d50' }
local grey_fg2 = { '#50575a' }
local lavender = { '#cb9ad6' }
local light_grey = { '#50575a' }
local line = { '#22292b' }
local maroon = { '#dda9d3' }
local nord_blue = { '#547f9f' }
local one_bg = { '#1e2528' }
local one_bg2 = { '#272e31' }
local one_bg3 = { '#2f3639' }
local orange = { '#fcb163' }
local pink = { '#ee9cdd' }
local purple = { '#c47fd5' }
local red = { '#e57474' }
local rosewater = { '#e7b2dc' }
local sapphire = { '#7ec5cd' }
local statusline = { '#181f22' }
local sun = { '#e2cd8c' }
local teal = { '#9bdead' }
local vibrant_green = { '#86d988' }
local white = { '#dadada' }
local yellow = { '#e5c76b' }
-- stylua: ignore end
