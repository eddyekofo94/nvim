...
-- stylua: ignore start
local baby_pink = { '#bda4bd' }
local black = { '#0f0f0f' }
local black2 = { '#181818' }
local blue = { '#9691b3' }
local cyan = { '#9EC3C4' }
local dark_purple = { '#b58fb5' }
local darker_black = { '#090909' }
local folder_bg = { '#8F8AAC' }
local green = { '#8aac8b' }
local grey = { '#373737' }
local grey_fg = { '#414141' }
local grey_fg2 = { '#4b4b4b' }
local lavender = { '#d1b7d1' }
local light_grey = { '#535353' }
local line = { '#242424' }
local maroon = { '#a692ae' }
local nord_blue = { '#6b687b' }
local one_bg = { '#191919' }
local one_bg2 = { '#222222' }
local one_bg3 = { '#2a2a2a' }
local orange = { '#9d9a7b' }
local pink = { '#AC8AAC' }
local purple = { '#C49EC4' }
local red = { '#ac8a8c' }
local rosewater = { '#c4aec4' }
local sapphire = { '#93a1b4' }
local statusline = { '#131313' }
local sun = { '#c0bea9' }
local teal = { '#8fb4b5' }
local vibrant_green = { '#99bb9a' }
local white = { '#F0f0f0' }
local yellow = { '#ACA98A' }
-- stylua: ignore end
