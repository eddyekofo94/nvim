...
-- stylua: ignore start
local baby_pink = { '#e688c4' }
local black = { '#24292E' }
local black2 = { '#2e3338' }
local blue = { '#79c0ff' }
local cyan = { '#56d4dd' }
local dark_purple = { '#bc8cff' }
local darker_black = { '#1F2428' }
local folder_bg = { '#58a6ff' }
local green = { '#56d364' }
local grey = { '#4c5156' }
local grey_fg = { '#565b60' }
local grey_fg2 = { '#60656a' }
local lavender = { '#d2b7f7' }
local light_grey = { '#6a6f74' }
local line = { '#33383d' }
local maroon = { '#c87ebd' }
local nord_blue = { '#658eb3' }
local one_bg = { '#33383d' }
local one_bg2 = { '#383d42' }
local one_bg3 = { '#42474c' }
local orange = { '#ffab70' }
local pink = { '#ec6cb9' }
local purple = { '#d2a8ff' }
local red = { '#ff7f8d' }
local rosewater = { '#e393c8' }
local sapphire = { '#5cc2e9' }
local statusline = { '#2b3035' }
local sun = { '#f2de85' }
local teal = { '#39c5cf' }
local vibrant_green = { '#85e89d' }
local white = { '#d3dbe3' }
local yellow = { '#ffdf5d' }
-- stylua: ignore end
