...
-- stylua: ignore start
local baby_pink = { '#ec647c' }
local black = { '#1D1F27' }
local black2 = { '#282b36' }
local blue = { '#25B2BC' }
local cyan = { '#25B2BC' }
local dark_purple = { '#B180D7' }
local darker_black = { '#16181e' }
local folder_bg = { '#E95678' }
local green = { '#27D796' }
local grey = { '#4f546b' }
local grey_fg = { '#5b607b' }
local grey_fg2 = { '#676c8b' }
local lavender = { '#c194db' }
local light_grey = { '#757b99' }
local line = { '#3b3c41' }
local maroon = { '#ca5870' }
local nord_blue = { '#388898' }
local one_bg = { '#2f3340' }
local one_bg2 = { '#393d4d' }
local one_bg3 = { '#43485b' }
local orange = { '#F09383' }
local pink = { '#F43E5C' }
local purple = { '#B877DB' }
local red = { '#E95678' }
local rosewater = { '#e97488' }
local sapphire = { '#23b8bf' }
local statusline = { '#21242d' }
local sun = { '#efc9ad' }
local teal = { '#21BFC2' }
local vibrant_green = { '#21BFC2' }
local white = { '#D5D8DA' }
local yellow = { '#FAC29A' }
-- stylua: ignore end
