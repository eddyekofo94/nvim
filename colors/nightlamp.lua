...
-- stylua: ignore start
local baby_pink = { '#cfa9ac' }
local black = { '#18191f' }
local black2 = { '#202127' }
local blue = { '#5a6986' }
local cyan = { '#90a0a0' }
local dark_purple = { '#a99bca' }
local darker_black = { '#13141a' }
local folder_bg = { '#90a0a0' }
local green = { '#8aa387' }
local grey = { '#3d3e44' }
local grey_fg = { '#48494f' }
local grey_fg2 = { '#4d4e54' }
local lavender = { '#c4b7d1' }
local light_grey = { '#55565c' }
local line = { '#313238' }
local maroon = { '#b99ea8' }
local nord_blue = { '#4d5668' }
local one_bg = { '#27282e' }
local one_bg2 = { '#2d2e34' }
local one_bg3 = { '#33343a' }
local orange = { '#cd9672' }
local pink = { '#c99aa7' }
local purple = { '#b8aad9' }
local red = { '#a67476' }
local rosewater = { '#d1afaf' }
local sapphire = { '#688796' }
local statusline = { '#1d1e24' }
local sun = { '#d2c1a6' }
local teal = { '#7aacaa' }
local vibrant_green = { '#94ad91' }
local white = { '#e0d6bd' }
local yellow = { '#ccb89c' }
-- stylua: ignore end
