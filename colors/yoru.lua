...
-- stylua: ignore start
local baby_pink = { '#e9878c' }
local black = { '#0c0e0f' }
local black2 = { '#141617' }
local blue = { '#6791C9' }
local cyan = { '#67AFC1' }
local dark_purple = { '#BC83E3' }
local darker_black = { '#060809' }
local folder_bg = { '#6791C9' }
local green = { '#78B892' }
local grey = { '#343637' }
local grey_fg = { '#3e4041' }
local grey_fg2 = { '#484a4b' }
local lavender = { '#d1aaed' }
local light_grey = { '#505253' }
local line = { '#1b1d1e' }
local maroon = { '#d0757d' }
local nord_blue = { '#506887' }
local one_bg = { '#161819' }
local one_bg2 = { '#1f2122' }
local one_bg3 = { '#27292a' }
local orange = { '#E89982' }
local pink = { '#e8646a' }
local purple = { '#c58cec' }
local red = { '#DF5B61' }
local rosewater = { '#ea9599' }
local sapphire = { '#6ba3c9' }
local statusline = { '#101213' }
local sun = { '#ecdba9' }
local teal = { '#70b8ca' }
local vibrant_green = { '#81c19b' }
local white = { '#edeff0' }
local yellow = { '#ecd28b' }
-- stylua: ignore end
