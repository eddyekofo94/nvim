...
-- stylua: ignore start
local baby_pink = { '#f4bfc2' }
local black = { '#0F111A' }
local black2 = { '#191d2c' }
local blue = { '#82aaff' }
local cyan = { '#89ddff' }
local dark_purple = { '#a652de' }
local darker_black = { '#0a0b14' }
local folder_bg = { '#6e98eb' }
local green = { '#c3e88d' }
local grey = { '#3c476b' }
local grey_fg = { '#46537d' }
local grey_fg2 = { '#505f8f' }
local lavender = { '#d3b3f0' }
local light_grey = { '#5a6ba1' }
local line = { '#313855' }
local maroon = { '#deb1b2' }
local nord_blue = { '#627dbc' }
local one_bg = { '#23293e' }
local one_bg2 = { '#2d3550' }
local one_bg3 = { '#374162' }
local orange = { '#f78c6c' }
local pink = { '#f6aaae' }
local purple = { '#c792ea' }
local red = { '#f07178' }
local rosewater = { '#f3c8ca' }
local sapphire = { '#81b9e4' }
local statusline = { '#181c2b' }
local sun = { '#fadb97' }
local teal = { '#80cbc4' }
local vibrant_green = { '#81bf27' }
local white = { '#eeffff' }
local yellow = { '#ffcb6b' }
-- stylua: ignore end
