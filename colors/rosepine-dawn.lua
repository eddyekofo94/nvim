...
-- stylua: ignore start
local baby_pink = { '#c6688c' }
local black = { '#faf4ed' }
local black2 = { '#EDE1D6' }
local blue = { '#56949f' }
local cyan = { '#d7827e' }
local dark_purple = { '#c4a7e7' }
local darker_black = { '#f2e9e1' }
local folder_bg = { '#56949f' }
local green = { '#286983' }
local grey = { '#b0acb9' }
local grey_fg = { '#A39EAD' }
local grey_fg2 = { '#9893A4' }
local lavender = { '#7f6e9b' }
local light_grey = { '#908B9D' }
local line = { '#EADCCF' }
local maroon = { '#c87598' }
local nord_blue = { '#7e9fab' }
local one_bg = { '#EADCCF' }
local one_bg2 = { '#E4D2C1' }
local one_bg3 = { '#DEC7B3' }
local orange = { '#ea9d34' }
local pink = { '#eb6f92' }
local purple = { '#907aa9' }
local red = { '#b4637a' }
local rosewater = { '#b76589' }
local sapphire = { '#4b92a7' }
local statusline = { '#f2e9e1' }
local sun = { '#be8649' }
local teal = { '#3e8fb0' }
local vibrant_green = { '#3e8fb0' }
local white = { '#575279' }
local yellow = { '#ea9d34' }
-- stylua: ignore end
