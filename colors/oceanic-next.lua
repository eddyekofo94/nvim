...
-- stylua: ignore start
local baby_pink = { '#f5bbc4' }
local black = { '#1B2B34' }
local black2 = { '#21313a' }
local blue = { '#6699CC' }
local cyan = { '#62B3B2' }
local dark_purple = { '#ac7bac' }
local darker_black = { '#15252e' }
local folder_bg = { '#598cbf' }
local green = { '#99C794' }
local grey = { '#43535c' }
local grey_fg = { '#4d5d66' }
local grey_fg2 = { '#576770' }
local lavender = { '#cbaad0' }
local light_grey = { '#5f6f78' }
local line = { '#2a3a43' }
local maroon = { '#dcadb3' }
local nord_blue = { '#567a9a' }
local one_bg = { '#25353e' }
local one_bg2 = { '#2e3e47' }
local one_bg3 = { '#36464f' }
local orange = { '#F99157' }
local pink = { '#ffafb7' }
local purple = { '#C594C5' }
local red = { '#EC5F67' }
local rosewater = { '#f1bfc8' }
local sapphire = { '#5c9eba' }
local statusline = { '#1f2f38' }
local sun = { '#f0cf8b' }
local teal = { '#50a4a4' }
