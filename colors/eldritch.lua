...
-- stylua: ignore start
local baby_pink = { '#ca7aa9' }
local black = { '#171928' }
local black2 = { '#202338' }
local blue = { '#04D1F9' }
local cyan = { '#04D1F9' }
local dark_purple = { '#5866A2' }
local darker_black = { '#131421' }
local folder_bg = { '#66E4FD' }
local green = { '#37F499' }
local grey = { '#444B78' }
local grey_fg = { '#4D5588' }
local grey_fg2 = { '#4C5488' }
local lavender = { '#b9adf4' }
local light_grey = { '#6770AA' }
local line = { '#3B4261' }
local maroon = { '#a3678b' }
local nord_blue = { '#2195bf' }
local one_bg = { '#292D48' }
local one_bg2 = { '#323758' }
local one_bg3 = { '#323758' }
local orange = { '#F7C67F' }
local pink = { '#BF4F8E' }
local purple = { '#A48CF2' }
local red = { '#F16C75' }
local rosewater = { '#ce8bb4' }
local sapphire = { '#19ccc2' }
local statusline = { '#1E2134' }
local sun = { '#effba0' }
local teal = { '#33C57F' }
local vibrant_green = { '#00FA82' }
local white = { '#EBFAFA' }
local yellow = { '#F1FC79' }
-- stylua: ignore end
