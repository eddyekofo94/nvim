...
-- stylua: ignore start
local baby_pink = { '#f0687e' }
local black = { '#242424' }
local black2 = { '#2b2b2b' }
local blue = { '#24ACD4' }
local cyan = { '#24DFC4' }
local dark_purple = { '#B180D7' }
local darker_black = { '#1c1c1c' }
local folder_bg = { '#24ACD4' }
local green = { '#47B413' }
local grey = { '#474747' }
local grey_fg = { '#4e4e4e' }
local grey_fg2 = { '#555555' }
local lavender = { '#c698de' }
local light_grey = { '#5c5c5c' }
local line = { '#3b3c41' }
local maroon = { '#ca5870' }
local nord_blue = { '#347f95' }
local one_bg = { '#323232' }
local one_bg2 = { '#393939' }
local one_bg3 = { '#404040' }
local orange = { '#F09383' }
local pink = { '#F43E5C' }
local purple = { '#B877DB' }
local red = { '#F62B5A' }
local rosewater = { '#ef798c' }
local sapphire = { '#23b5cc' }
local statusline = { '#2b2b2b' }
local sun = { '#e4ce46' }
local teal = { '#21BFC2' }
