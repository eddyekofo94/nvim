...
-- stylua: ignore start
local baby_pink = { '#900db1' }
local black = { '#FFFFFF' }
local black2 = { '#efefef' }
local blue = { '#007ACC' }
local cyan = { '#0064C1' }
local dark_purple = { '#0451A5' }
local darker_black = { '#efefef' }
local folder_bg = { '#007ACC' }
local green = { '#008000' }
local grey = { '#cfcfcf' }
local grey_fg = { '#c7c7c7' }
local grey_fg2 = { '#bfbfbf' }
local lavender = { '#101069' }
local light_grey = { '#afafaf' }
local line = { '#e6e6e6' }
local maroon = { '#901ac2' }
local nord_blue = { '#5da0cd' }
local one_bg = { '#e7e7e7' }
local one_bg2 = { '#dfdfdf' }
local one_bg3 = { '#d7d7d7' }
local orange = { '#C72E0F' }
local pink = { '#AF00DB' }
local purple = { '#000080' }
local red = { '#FF0000' }
local rosewater = { '#8412a1' }
local sapphire = { '#0a7e9a' }
local statusline = { '#efefef' }
local sun = { '#64512a' }
local teal = { '#16825D' }
local vibrant_green = { '#098658' }
local white = { '#343434' }
local yellow = { '#795E26' }
-- stylua: ignore end
