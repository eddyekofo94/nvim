...
-- stylua: ignore start
local baby_pink = { '#f4b2b2' }
local black = { '#101317' }
local black2 = { '#191d22' }
local blue = { '#7ab0df' }
local cyan = { '#50cad2' }
local dark_purple = { '#b68acb' }
local darker_black = { '#0a0d11' }
local folder_bg = { '#5fb0fc' }
local green = { '#37d99e' }
local grey = { '#3e4145' }
local grey_fg = { '#45484c' }
local grey_fg2 = { '#4a4d51' }
local lavender = { '#c8a9d7' }
local light_grey = { '#525559' }
local line = { '#30303a' }
local maroon = { '#e0a9a8' }
local nord_blue = { '#5f7e9a' }
local one_bg = { '#212428' }
local one_bg2 = { '#292c30' }
local one_bg3 = { '#33363a' }
local orange = { '#f0a988' }
local pink = { '#ffa7a7' }
local purple = { '#c397d8' }
local red = { '#f87070' }
local rosewater = { '#f0b7b7' }
local sapphire = { '#70b1c8' }
local statusline = { '#15191e' }
local sun = { '#f2e0ae' }
local teal = { '#63b3ad' }
local vibrant_green = { '#79dcaa' }
local white = { '#d4d4d5' }
local yellow = { '#ffe59e' }
-- stylua: ignore end
