...
-- stylua: ignore start
local baby_pink = { '#dfc6c5' }
local black = { '#4A4A4A' }
local black2 = { '#515151' }
local blue = { '#96BBDC' }
local cyan = { '#96DDDE' }
local dark_purple = { '#FFBEB0' }
local darker_black = { '#444444' }
local folder_bg = { '#67A9AA' }
local green = { '#719672' }
local grey = { '#6d6d6d' }
local grey_fg = { '#747474' }
local grey_fg2 = { '#7b7b7b' }
local lavender = { '#dfc8c7' }
local light_grey = { '#828282' }
local line = { '#606060' }
local maroon = { '#ccbcbc' }
local nord_blue = { '#8498aa' }
local one_bg = { '#585858' }
local one_bg2 = { '#5f5f5f' }
local one_bg3 = { '#666666' }
local orange = { '#ffcb88' }
local pink = { '#DFBDBC' }
local purple = { '#DFBDBC' }
local red = { '#DF9A98' }
local rosewater = { '#dfc9c9' }
local sapphire = { '#8cb9ce' }
local statusline = { '#515151' }
local sun = { '#e0c692' }
local teal = { '#7FB7BD' }
local vibrant_green = { '#97BB98' }
local white = { '#DFE0E0' }
local yellow = { '#E0BB71' }
-- stylua: ignore end
