...
-- stylua: ignore start
local baby_pink = { '#d2c8f9' }
local black = { '#1E1C31' }
local black2 = { '#23213a' }
local blue = { '#91ddff' }
local cyan = { '#aaffe4' }
local dark_purple = { '#a87ffc' }
local darker_black = { '#181627' }
local folder_bg = { '#78A8ff' }
local green = { '#a1efd3' }
local grey = { '#413f70' }
local grey_fg = { '#4b4982' }
local grey_fg2 = { '#504e8b' }
local lavender = { '#d1caf8' }
local light_grey = { '#555394' }
local line = { '#2d2b4c' }
local maroon = { '#ccccfa' }
local nord_blue = { '#6d96bf' }
local one_bg = { '#282643' }
local one_bg2 = { '#2d2b4c' }
local one_bg3 = { '#37355e' }
local orange = { '#ffb378' }
local pink = { '#d4bfff' }
local purple = { '#d4bfff' }
local red = { '#f48fb1' }
local rosewater = { '#d1ccf7' }
local sapphire = { '#9cecf3' }
local statusline = { '#23213a' }
local sun = { '#efc199' }
local teal = { '#aaffe4' }
local vibrant_green = { '#62d196' }
local white = { '#cbe3e7' }
local yellow = { '#ffb378' }
-- stylua: ignore end
