...
-- stylua: ignore start
local baby_pink = { '#ef8ab5' }
local black = { '#1a1b26' }
local black2 = { '#1f2336' }
local blue = { '#7aa2f7' }
local cyan = { '#7dcfff' }
local dark_purple = { '#9d7cd8' }
local darker_black = { '#16161e' }
local folder_bg = { '#7aa2f7' }
local green = { '#9ece6a' }
local grey = { '#40486a' }
local grey_fg = { '#565f89' }
local grey_fg2 = { '#4f5779' }
local lavender = { '#bca8f6' }
local light_grey = { '#545c7e' }
local line = { '#32333e' }
local maroon = { '#d1839f' }
local nord_blue = { '#607ab8' }
local one_bg = { '#24283b' }
local one_bg2 = { '#414868' }
local one_bg3 = { '#353b45' }
local orange = { '#ff9e64' }
local pink = { '#ff75a0' }
local purple = { '#bb9af7' }
local red = { '#f7768e' }
local rosewater = { '#e993be' }
local sapphire = { '#4faece' }
local statusline = { '#1d1e29' }
local sun = { '#d6b792' }
local teal = { '#1abc9c' }
local vibrant_green = { '#73daca' }
local white = { '#c0caf5' }
local yellow = { '#e0af68' }
-- stylua: ignore end
