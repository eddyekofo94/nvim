...
-- stylua: ignore start
local baby_pink = { '#f796c0' }
local black = { '#161616' }
local black2 = { '#1d1d1d' }
local blue = { '#78A9FF' }
local cyan = { '#3DDBD9' }
local dark_purple = { '#9B69D9' }
local darker_black = { '#0e0e0e' }
local folder_bg = { '#78A9FF' }
local green = { '#25be6a' }
local grey = { '#404040' }
local grey_fg = { '#4e4e4e' }
local grey_fg2 = { '#5c5c5c' }
local lavender = { '#c8abf6' }
local light_grey = { '#636363' }
local line = { '#2a2a2a' }
local maroon = { '#d688c5' }
local nord_blue = { '#5f7aa9' }
local one_bg = { '#242424' }
local one_bg2 = { '#2b2b2b' }
local one_bg3 = { '#323232' }
local orange = { '#ffa332' }
local pink = { '#FF7EB6' }
local purple = { '#BE95FF' }
local red = { '#EE5396' }
local rosewater = { '#f4a0c5' }
local sapphire = { '#59adff' }
local statusline = { '#1d1d1d' }
local sun = { '#f5e566' }
local teal = { '#33B1FF' }
local vibrant_green = { '#42BE65' }
local white = { '#dfdfe0' }
local yellow = { '#ffe731' }
-- stylua: ignore end
