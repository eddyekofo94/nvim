...
-- stylua: ignore start
local baby_pink = { '#d0807b' }
local black = { '#252221' }
local black2 = { '#2b2827' }
local blue = { '#7d92a2' }
local cyan = { '#829e9b' }
local dark_purple = { '#917b8e' }
local darker_black = { '#201d1c' }
local folder_bg = { '#768b9b' }
local green = { '#8ca589' }
local grey = { '#4d4a49' }
local grey_fg = { '#575453' }
local grey_fg2 = { '#615e5d' }
local lavender = { '#a9959d' }
local light_grey = { '#6b6867' }
local line = { '#322f2e' }
local maroon = { '#be7370' }
local nord_blue = { '#67727a' }
local one_bg = { '#2f2c2b' }
local one_bg2 = { '#393635' }
local one_bg3 = { '#43403f' }
local orange = { '#d08b65' }
local pink = { '#d16a6a' }
local purple = { '#998396' }
local red = { '#c65f5f' }
local rosewater = { '#d08881' }
local sapphire = { '#799497' }
local statusline = { '#292625' }
local sun = { '#d5b68b' }
local teal = { '#749689' }
local vibrant_green = { '#95ae92' }
local white = { '#cdc0ad' }
local yellow = { '#d9b27c' }
-- stylua: ignore end
