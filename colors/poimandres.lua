...
-- stylua: ignore start
local baby_pink = { '#f6d0ee' }
local black = { '#1b1e28' }
local black2 = { '#222633' }
local blue = { '#89DDFF' }
local cyan = { '#92e0ff' }
local dark_purple = { '#b6d7f4' }
local darker_black = { '#171922' }
local folder_bg = { '#91B4D5' }
local green = { '#5FB3A1' }
local grey = { '#48506a' }
local grey_fg = { '#515977' }
local grey_fg2 = { '#5d678a' }
local lavender = { '#b9c0db' }
local light_grey = { '#657096' }
local line = { '#303340' }
local maroon = { '#dccbe2' }
local nord_blue = { '#6c9ebc' }
local one_bg = { '#2b3040' }
local one_bg2 = { '#32384a' }
local one_bg3 = { '#3b4258' }
local orange = { '#91B4D5' }
local pink = { '#FCC5E9' }
local purple = { '#A6ACCD' }
local red = { '#D0679D' }
local rosewater = { '#f4d4ef' }
local sapphire = { '#75e0e6' }
local statusline = { '#222633' }
local sun = { '#f7f7d3' }
local teal = { '#5DE4C7' }
local vibrant_green = { '#71bbab' }
local white = { '#E4F0FB' }
local yellow = { '#FFFAC2' }
-- stylua: ignore end
