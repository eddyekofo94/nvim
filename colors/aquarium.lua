...
-- stylua: ignore start
local baby_pink = { '#e2d2d4' }
local black = { '#20202A' }
local black2 = { '#25252f' }
local blue = { '#CDDBF9' }
local cyan = { '#b8dceb' }
local dark_purple = { '#E8B6E9' }
local darker_black = { '#1c1c26' }
local folder_bg = { '#b8dceb' }
local green = { '#b1dba4' }
local grey = { '#484852' }
local grey_fg = { '#4e4e58' }
local grey_fg2 = { '#54545e' }
local lavender = { '#eac2e5' }
local light_grey = { '#5a5a64' }
local line = { '#2d2d37' }
local maroon = { '#ddd3cc' }
local nord_blue = { '#9199ae' }
local one_bg = { '#2a2a34' }
local one_bg2 = { '#34343e' }
local one_bg3 = { '#3e3e48' }
local orange = { '#E8CCA7' }
local pink = { '#E9D1D1' }
local purple = { '#f6bbe7' }
local red = { '#ebb9b9' }
local rosewater = { '#e0d2d6' }
local sapphire = { '#bfdbdb' }
local statusline = { '#262630' }
local sun = { '#dfdcc4' }
local teal = { '#AEDCB7' }
local vibrant_green = { '#BEE0A8' }
local white = { '#ced4df' }
local yellow = { '#E6DFB8' }
-- stylua: ignore end
