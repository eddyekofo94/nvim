...
-- stylua: ignore start
local baby_pink = { '#c98688' }
local black = { '#d8dee9' }
local black2 = { '#cbd1dc' }
local blue = { '#526f93' }
local cyan = { '#0b8ec6' }
local dark_purple = { '#6b4c7a' }
local darker_black = { '#d1d7e2' }
local folder_bg = { '#526f93' }
local green = { '#5b9c90' }
local grey = { '#adb3be' }
local grey_fg = { '#a3a9b4' }
local grey_fg2 = { '#999faa' }
local lavender = { '#6b5678' }
local light_grey = { '#9197a2' }
local line = { '#c6ccd7' }
local maroon = { '#d1aaa3' }
local nord_blue = { '#7b8ea6' }
local one_bg = { '#cbd1dc' }
local one_bg2 = { '#c2c8d3' }
local one_bg3 = { '#bac0cb' }
local orange = { '#f99157' }
local pink = { '#ffa5a5' }
local purple = { '#896a98' }
local red = { '#b40b11' }
local rosewater = { '#b37a7c' }
local sapphire = { '#399297' }
local statusline = { '#cfd5e0' }
local sun = { '#bc8d30' }
local teal = { '#1abc9c' }
local vibrant_green = { '#9fab4e' }
local white = { '#26292f' }
local yellow = { '#fdb830' }
-- stylua: ignore end
