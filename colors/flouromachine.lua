...
-- stylua: ignore start
local baby_pink = { '#fe737c' }
local black = { '#262335' }
local black2 = { '#2c293e' }
local blue = { '#61E2FF' }
local cyan = { '#61E2FF' }
local dark_purple = { '#AF6DF9' }
local darker_black = { '#1f1c2b' }
local folder_bg = { '#61E2FF' }
local green = { '#72F1B8' }
local grey = { '#4a476b' }
local grey_fg = { '#545076' }
local grey_fg2 = { '#5a567f' }
local lavender = { '#c799fb' }
local light_grey = { '#605c88' }
local line = { '#383550' }
local maroon = { '#df6473' }
local nord_blue = { '#579cbc' }
local one_bg = { '#322f47' }
local one_bg2 = { '#383550' }
local one_bg3 = { '#3e3b59' }
local orange = { '#FF8B39' }
local pink = { '#FE4450' }
local purple = { '#AF6DF9' }
local red = { '#FE4450' }
local rosewater = { '#fe858d' }
local sapphire = { '#61e2ff' }
local statusline = { '#2c293e' }
local sun = { '#ffdb4d' }
local teal = { '#61E2FF' }
local vibrant_green = { '#72F1B8' }
local white = { '#ffffff' }
local yellow = { '#FFCC00' }
-- stylua: ignore end
