...
-- stylua: ignore start
local baby_pink = { '#ee88ac' }
local black = { '#282c34' }
local black2 = { '#2e323a' }
local blue = { '#51afef' }
local cyan = { '#46D9FF' }
local dark_purple = { '#c678dd' }
local darker_black = { '#22262e' }
local folder_bg = { '#51afef' }
local green = { '#98be65' }
local grey = { '#494d55' }
local grey_fg = { '#53575f' }
local grey_fg2 = { '#5d6169' }
local lavender = { '#d29ee8' }
local light_grey = { '#676b73' }
local line = { '#3b3f47' }
local maroon = { '#db82a6' }
local nord_blue = { '#4d83aa' }
local one_bg = { '#32363e' }
local one_bg2 = { '#3c4048' }
local one_bg3 = { '#41454d' }
local orange = { '#ea9558' }
local pink = { '#ff75a0' }
local purple = { '#dc8ef3' }
local red = { '#ff6b5a' }
local rosewater = { '#e790b0' }
local sapphire = { '#4fb2d8' }
local statusline = { '#2d3139' }
local sun = { '#ddbf94' }
local teal = { '#4db5bd' }
local vibrant_green = { '#a9cf76' }
local white = { '#bbc2cf' }
local yellow = { '#ECBE7B' }
-- stylua: ignore end
