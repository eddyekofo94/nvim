...
local lavender = { '#cfa0ea' }
local light_grey = { '#6f737b' }
local line = { '#31353d' }
local maroon = { '#dc7ca5' }
local nord_blue = { '#5380a7' }
local one_bg = { '#282c34' }
local one_bg2 = { '#353b45' }
local one_bg3 = { '#373b43' }
local orange = { '#fca2aa' }
local pink = { '#ff75a0' }
local purple = { '#de98fd' }
local red = { '#e06c75' }
local rosewater = { '#e28aab' }
local sapphire = { '#5aa6d7' }
local statusline = { '#22262e' }
local sun = { '#d5c198' }
local teal = { '#519ABA' }
