...
-- stylua: ignore start
local baby_pink = { '#ab8270' }
local black = { '#e6dfdc' }
local black2 = { '#d9d2cf' }
local blue = { '#5f7d9b' }
local cyan = { '#75998e' }
local dark_purple = { '#9c7b9c' }
local darker_black = { '#dfd8d5' }
local folder_bg = { '#746d6a' }
local green = { '#6c805c' }
local grey = { '#b9b2af' }
local grey_fg = { '#b2aba8' }
local grey_fg2 = { '#aaa3a0' }
local lavender = { '#94798e' }
local light_grey = { '#a09996' }
local line = { '#d3ccc9' }
local maroon = { '#a9877b' }
local nord_blue = { '#8895a4' }
local one_bg = { '#d0c9c6' }
local one_bg2 = { '#c7c0bd' }
local one_bg3 = { '#c0b9b6' }
local orange = { '#cc836c' }
local pink = { '#c18f78' }
local purple = { '#a685a6' }
local red = { '#b28069' }
local rosewater = { '#a27e6c' }
local sapphire = { '#567492' }
local statusline = { '#dcd5d2' }
local sun = { '#968d89' }
local teal = { '#4b6987' }
local vibrant_green = { '#899d79' }
local white = { '#695d57' }
local yellow = { '#a9a29f' }
-- stylua: ignore end
