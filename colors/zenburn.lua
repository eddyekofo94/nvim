...
-- stylua: ignore start
local baby_pink = { '#e5a9d2' }
local black = { '#383838' }
local black2 = { '#3f3f3f' }
local blue = { '#7cb8bb' }
local cyan = { '#93e0e3' }
local dark_purple = { '#7A89B4' }
local darker_black = { '#303030' }
local folder_bg = { '#7cb8bb' }
local green = { '#5f7f5f' }
local grey = { '#5b5b5b' }
local grey_fg = { '#626262' }
local grey_fg2 = { '#696969' }
local lavender = { '#d0b7f2' }
local light_grey = { '#707070' }
local line = { '#464646' }
local maroon = { '#cd9dc9' }
local nord_blue = { '#6d8e90' }
local one_bg = { '#464646' }
local one_bg2 = { '#4d4d4d' }
local one_bg3 = { '#545454' }
local orange = { '#dfaf8f' }
local pink = { '#dc8cc3' }
local purple = { '#BC98EC' }
local red = { '#dca3a3' }
local rosewater = { '#e8b4d8' }
local sapphire = { '#86cacd' }
local statusline = { '#3f3f3f' }
local sun = { '#e9ddbc' }
local teal = { '#93e0e3' }
local vibrant_green = { '#5f7f5f' }
local white = { '#ffffff' }
local yellow = { '#e0cf9f' }
-- stylua: ignore end
