...
-- stylua: ignore start
local baby_pink = { '#da999f' }
local black = { '#1a2026' }
local black2 = { '#20262c' }
local blue = { '#6b8bab' }
local cyan = { '#9aafe6' }
local dark_purple = { '#8f8aac' }
local darker_black = { '#151b21' }
local folder_bg = { '#6b8bab' }
local green = { '#8aac8b' }
local grey = { '#42484e' }
local grey_fg = { '#474d53' }
local grey_fg2 = { '#50565c' }
local lavender = { '#a7a3be' }
local light_grey = { '#565c62' }
local line = { '#2d3339' }
local maroon = { '#d293a0' }
local nord_blue = { '#596d81' }
local one_bg = { '#242a30' }
local one_bg2 = { '#292f35' }
local one_bg3 = { '#2e343a' }
local orange = { '#C9938A' }
local pink = { '#e89199' }
local purple = { '#a39ec4' }
local red = { '#ac8a8c' }
local rosewater = { '#d49ca1' }
local sapphire = { '#7393b3' }
local statusline = { '#1e242a' }
local sun = { '#bebca3' }
local teal = { '#7c9cbc' }
local vibrant_green = { '#9ec49f' }
local white = { '#b0b0b0' }
local yellow = { '#c4c19e' }
-- stylua: ignore end
