...
-- stylua: ignore start
local baby_pink = { '#d46d8f' }
local black = { '#fafafa' }
local black2 = { '#EAEAEB' }
local blue = { '#4078f2' }
local cyan = { '#0b8ec6' }
local dark_purple = { '#8e79b9' }
local darker_black = { '#efeff0' }
local folder_bg = { '#6C6C6C' }
local green = { '#50a14f' }
local grey = { '#b7b7b8' }
local grey_fg = { '#b0b0b1' }
local grey_fg2 = { '#a9a9aa' }
local lavender = { '#8b7cab' }
local light_grey = { '#a2a2a3' }
local line = { '#e2e2e2' }
local maroon = { '#dc7ca5' }
local nord_blue = { '#7694d8' }
local one_bg = { '#dadadb' }
local one_bg2 = { '#d4d4d5' }
local one_bg3 = { '#cccccd' }
local orange = { '#FF6A00' }
local pink = { '#ff75a0' }
local purple = { '#a28dcd' }
local red = { '#d84a3d' }
local rosewater = { '#c36a88' }
local sapphire = { '#4887d9' }
local statusline = { '#ececec' }
local sun = { '#a0761c' }
local teal = { '#519ABA' }
