...
-- stylua: ignore start
local baby_pink = { '#943670' }
local black = { '#ffffff' }
local black2 = { '#edeff1' }
local blue = { '#0D7FDD' }
local cyan = { '#0598bc' }
local dark_purple = { '#5a32a3' }
local darker_black = { '#f3f5f7' }
local folder_bg = { '#6a737d' }
local green = { '#18654B' }
local grey = { '#c7c9cb' }
local grey_fg = { '#bcbec0' }
local grey_fg2 = { '#b1b3b5' }
local lavender = { '#6652b2' }
local light_grey = { '#a6a8aa' }
local line = { '#eaecee' }
local maroon = { '#9b498a' }
local nord_blue = { '#61a0d5' }
local one_bg = { '#eaecee' }
local one_bg2 = { '#e1e3e5' }
local one_bg3 = { '#d7d9db' }
local orange = { '#d15704' }
local pink = { '#b93a86' }
local purple = { '#8263EB' }
local red = { '#DE2C2E' }
local rosewater = { '#853467' }
local sapphire = { '#1681bf' }
local statusline = { '#edeff1' }
local sun = { '#a48414' }
local teal = { '#22839b' }
local vibrant_green = { '#28a745' }
local white = { '#24292e' }
local yellow = { '#dbab09' }
-- stylua: ignore end
