...
-- stylua: ignore start
local baby_pink = { '#cc7ad8' }
local black = { '#EFF1F5' }
local black2 = { '#dbdfe9' }
local blue = { '#04A5E5' }
local cyan = { '#209FB5' }
local dark_purple = { '#DD7878' }
local darker_black = { '#E6E9EF' }
local folder_bg = { '#666983' }
local green = { '#40A02B' }
local grey = { '#b3bbd1' }
local grey_fg = { '#a9b2cb' }
local grey_fg2 = { '#9fa9c5' }
local lavender = { '#8150f3' }
local light_grey = { '#8b97b9' }
local line = { '#d4d6dc' }
local maroon = { '#c07cc1' }
local nord_blue = { '#53afdc' }
local one_bg = { '#d1d6e3' }
local one_bg2 = { '#c7cddd' }
local one_bg3 = { '#bdc4d7' }
local orange = { '#FE640B' }
local pink = { '#EA76CB' }
local purple = { '#8839EF' }
local red = { '#E64553' }
local rosewater = { '#c07cdc' }
local sapphire = { '#0d9cc3' }
local statusline = { '#DCE0E8' }
local sun = { '#be8c60' }
local teal = { '#179299' }
local vibrant_green = { '#40a02b' }
local white = { '#7287FD' }
local yellow = { '#DF8E1D' }
-- stylua: ignore end
