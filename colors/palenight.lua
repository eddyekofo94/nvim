...
-- stylua: ignore start
local baby_pink = { '#ff7e94' }
local black = { '#292D3E' }
local black2 = { '#2f3344' }
local blue = { '#82aaff' }
local cyan = { '#89ddff' }
local dark_purple = { '#b383d2' }
local darker_black = { '#232738' }
local folder_bg = { '#82aaff' }
local green = { '#c3e88d' }
local grey = { '#515566' }
local grey_fg = { '#5b5f70' }
local grey_fg2 = { '#65697a' }
local lavender = { '#d8b3f0' }
local light_grey = { '#6d7182' }
local line = { '#3f4354' }
local maroon = { '#e77588' }
local nord_blue = { '#6c84ba' }
local one_bg = { '#333748' }
local one_bg2 = { '#3c4051' }
local one_bg3 = { '#444859' }
local orange = { '#ffa282' }
local pink = { '#ff5370' }
local purple = { '#c792ea' }
local red = { '#f07178' }
local rosewater = { '#ff8fa2' }
local sapphire = { '#85d0f4' }
local statusline = { '#2d3142' }
local sun = { '#ffdb97' }
local teal = { '#89ffe6' }
local vibrant_green = { '#96e88d' }
local white = { '#ffffff' }
local yellow = { '#ffcb6b' }
-- stylua: ignore end
