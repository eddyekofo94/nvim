...
-- stylua: ignore start
local baby_pink = { '#eaa8b6' }
local black = { '#131a21' }
local black2 = { '#1a2128' }
local blue = { '#99aee5' }
local cyan = { '#b5c3ea' }
local dark_purple = { '#b696d7' }
local darker_black = { '#10171e' }
local folder_bg = { '#99aee5' }
local green = { '#9fe8c3' }
local grey = { '#363d44' }
local grey_fg = { '#4e555c' }
local grey_fg2 = { '#51585f' }
local lavender = { '#beaadb' }
local light_grey = { '#545b62' }
local line = { '#272e35' }
local maroon = { '#e7adb0' }
local nord_blue = { '#6c7b9d' }
local one_bg = { '#1e252c' }
local one_bg2 = { '#2a3138' }
local one_bg3 = { '#363d44' }
local orange = { '#EDA685' }
local pink = { '#fca2af' }
local purple = { '#c2a2e3' }
local red = { '#ef8891' }
local rosewater = { '#e3abb8' }
local sapphire = { '#96c2d0' }
local statusline = { '#181f26' }
local sun = { '#e6d4a1' }
local teal = { '#92dbb6' }
local vibrant_green = { '#9ce5c0' }
local white = { '#b5bcc9' }
local yellow = { '#fbdf90' }
-- stylua: ignore end
