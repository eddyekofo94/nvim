...
-- stylua: ignore start
local baby_pink = { '#f17ac3' }
local black = { '#011627' }
local black2 = { '#091e2f' }
local blue = { '#82aaff' }
local cyan = { '#aad2ff' }
local dark_purple = { '#a974cc' }
local darker_black = { '#010f20' }
local folder_bg = { '#82aaff' }
local green = { '#29E68E' }
local grey = { '#2c4152' }
local grey_fg = { '#34495a' }
local grey_fg2 = { '#3c5162' }
local lavender = { '#cca9ea' }
local light_grey = { '#495e6f' }
local line = { '#182d3e' }
local maroon = { '#e670b6' }
local nord_blue = { '#5b7bb1' }
local one_bg = { '#112637' }
local one_bg2 = { '#1b3041' }
local one_bg3 = { '#253a4b' }
local orange = { '#FFAD60' }
local pink = { '#fa58b6' }
local purple = { '#c792ea' }
local red = { '#f78c6c' }
local rosewater = { '#ed87c9' }
local sapphire = { '#8bbadd' }
local statusline = { '#051a2b' }
local sun = { '#f3d1a8' }
local teal = { '#96CEB4' }
local vibrant_green = { '#22da6e' }
local white = { '#d6deeb' }
local yellow = { '#ffcb8b' }
-- stylua: ignore end
