...
-- stylua: ignore start
local baby_pink = { '#c95591' }
local black = { '#002b36' }
local black2 = { '#06313c' }
local blue = { '#268bd2' }
local cyan = { '#2aa198' }
local dark_purple = { '#5d62b5' }
local darker_black = { '#002530' }
local folder_bg = { '#268bd2' }
local green = { '#859900' }
local grey = { '#28535e' }
local grey_fg = { '#325d68' }
local grey_fg2 = { '#3c6772' }
local lavender = { '#7f84c2' }
local light_grey = { '#446f7a' }
local line = { '#0f3a45' }
local maroon = { '#b94a8d' }
local nord_blue = { '#27729e' }
local one_bg = { '#0a3540' }
local one_bg2 = { '#133e49' }
local one_bg3 = { '#1b4651' }
local orange = { '#cb4b16' }
local pink = { '#d33682' }
local purple = { '#6c71c4' }
local red = { '#dc322f' }
local rosewater = { '#c56197' }
local sapphire = { '#3992c7' }
local statusline = { '#042f3a' }
local sun = { '#b29539' }
local teal = { '#519ABA' }
local vibrant_green = { '#b2c62d' }
local white = { '#abb2bf' }
local yellow = { '#b58900' }
-- stylua: ignore end
