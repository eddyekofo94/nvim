...
local blue = { '#7797b7' }
local cyan = { '#9aafe6' }
local dark_purple = { '#B48EAD' }
local darker_black = { '#252b37' }
local folder_bg = { '#7797b7' }
local green = { '#A3BE8C' }
local grey = { '#4d535f' }
local grey_fg = { '#545a66' }
local grey_fg2 = { '#595f6b' }
local lavender = { '#b8becb' }
local light_grey = { '#606672' }
local line = { '#414753' }
local maroon = { '#c28390' }
local nord_blue = { '#64788f' }
local one_bg = { '#343a46' }
local one_bg2 = { '#3e4450' }
local one_bg3 = { '#484e5a' }
local orange = { '#e39a83' }
local pink = { '#da838b' }
local purple = { '#aab1be' }
local red = { '#d57780' }
local rosewater = { '#d9a3ac' }
local sapphire = { '#6e8eae' }
local statusline = { '#333945' }
local sun = { '#e5d1a7' }
local teal = { '#6484a4' }
local vibrant_green = { '#afca98' }
local white = { '#D8DEE9' }
local yellow = { '#EBCB8B' }
-- stylua: ignore end
