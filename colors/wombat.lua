...
-- stylua: ignore start
local baby_pink = { '#e698f0' }
local black = { '#222222' }
local black2 = { '#292929' }
local blue = { '#88B8F6' }
local cyan = { '#90fdf8' }
local dark_purple = { '#c878f0' }
local darker_black = { '#1b1b1b' }
local folder_bg = { '#7BB0C9' }
local green = { '#AEE474' }
local grey = { '#4b4b4b' }
local grey_fg = { '#535353' }
local grey_fg2 = { '#5a5a5a' }
local lavender = { '#dea5f3' }
local light_grey = { '#646464' }
local line = { '#353535' }
local maroon = { '#d28bec' }
local nord_blue = { '#6d87a9' }
local one_bg = { '#333333' }
local one_bg2 = { '#3a3a3a' }
local one_bg3 = { '#414141' }
local orange = { '#FFCC66' }
local pink = { '#e780f8' }
local purple = { '#dc8cff' }
local red = { '#FF8F7E' }
local rosewater = { '#e6a2ec' }
local sapphire = { '#84b7dc' }
local statusline = { '#262626' }
local sun = { '#ecdfb8' }
local teal = { '#7EB6BC' }
local vibrant_green = { '#95e454' }
local white = { '#e4e0d7' }
local yellow = { '#efdeab' }
-- stylua: ignore end
