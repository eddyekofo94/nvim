...
-- stylua: ignore start
local baby_pink = { '#f79aba' }
local black = { '#191724' }
local black2 = { '#1f1d2a' }
local blue = { '#8bbec7' }
local cyan = { '#a3d6df' }
local dark_purple = { '#bb9ede' }
local darker_black = { '#13111e' }
local folder_bg = { '#6aadc8' }
local green = { '#ABE9B3' }
local grey = { '#3f3d4a' }
local grey_fg = { '#474552' }
local grey_fg2 = { '#514f5c' }
local lavender = { '#ccb8eb' }
local light_grey = { '#5d5b68' }
local line = { '#2e2c39' }
local maroon = { '#e18bad' }
local nord_blue = { '#69848f' }
local one_bg = { '#262431' }
local one_bg2 = { '#2d2b38' }
local one_bg3 = { '#353340' }
local orange = { '#f6c177' }
local pink = { '#ff83a6' }
local purple = { '#c4a7e7' }
local red = { '#eb6f92' }
local rosewater = { '#f4a3c1' }
local sapphire = { '#7cb6c7' }
local statusline = { '#201e2b' }
local sun = { '#efca9c' }
local teal = { '#6aadc8' }
local vibrant_green = { '#b5f3bd' }
local white = { '#e0def4' }
local yellow = { '#f6c177' }
-- stylua: ignore end
