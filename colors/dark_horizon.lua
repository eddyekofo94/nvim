...
-- stylua: ignore start
local baby_pink = { '#ff98b8' }
local black = { '#0e0e0e' }
local black2 = { '#181818' }
local blue = { '#25B0BC' }
local cyan = { '#6BE4E6' }
local dark_purple = { '#c65cc2' }
local darker_black = { '#080808' }
local folder_bg = { '#07929e' }
local green = { '#AAD84C' }
local grey = { '#363636' }
local grey_fg = { '#404040' }
local grey_fg2 = { '#4a4a4a' }
local lavender = { '#e59be2' }
local light_grey = { '#525252' }
local line = { '#1d1d1d' }
local maroon = { '#e37c9b' }
local nord_blue = { '#2d7980' }
local one_bg = { '#1c1c1c' }
local one_bg2 = { '#212121' }
local one_bg3 = { '#292929' }
local orange = { '#FFA500' }
local pink = { '#ff75a0' }
local purple = { '#da70d6' }
local red = { '#db627e' }
local rosewater = { '#ffa5c1' }
local sapphire = { '#49a4a5' }
