...
-- stylua: ignore start
local baby_pink = { '#885f7f' }
local black = { '#f8f8f8' }
local black2 = { '#e8e8e8' }
local blue = { '#71a8bd' }
local cyan = { '#5aa9a1' }
local dark_purple = { '#8b5b3c' }
local darker_black = { '#f0f0f0' }
local folder_bg = { '#66a1b8' }
local green = { '#93a956' }
local grey = { '#c0c0c0' }
local grey_fg = { '#b8b8b8' }
local grey_fg2 = { '#b0b0b0' }
local lavender = { '#85627d' }
local light_grey = { '#a8a8a8' }
local line = { '#d8d8d8' }
local maroon = { '#a283a3' }
local nord_blue = { '#95b3be' }
local one_bg = { '#e0e0e0' }
local one_bg2 = { '#d8d8d8' }
local one_bg3 = { '#d0d0d0' }
local orange = { '#d98e49' }
local pink = { '#ae77a1' }
local purple = { '#b481a8' }
local red = { '#ab4642' }
local rosewater = { '#7a5671' }
local sapphire = { '#71aeb6' }
local statusline = { '#efefef' }
local sun = { '#b07727' }
local teal = { '#70b5ad' }
local vibrant_green = { '#70b5ad' }
local white = { '#181818' }
local yellow = { '#f1a02e' }
-- stylua: ignore end
