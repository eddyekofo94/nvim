...
-- stylua: ignore start
local baby_pink = { '#e7c4c2' }
local black = { '#181818' }
local black2 = { '#262626' }
local blue = { '#7cafc2' }
local cyan = { '#86c1b9' }
local dark_purple = { '#a86c9a' }
local darker_black = { '#101010' }
local folder_bg = { '#7cafc2' }
local green = { '#a1b56c' }
local grey = { '#494949' }
local grey_fg = { '#575757' }
local grey_fg2 = { '#5e5e5e' }
local lavender = { '#cdacc5' }
local light_grey = { '#656565' }
local line = { '#3b3b3b' }
local maroon = { '#cab3ab' }
local nord_blue = { '#65818c' }
local one_bg = { '#2d2d2d' }
local one_bg2 = { '#343434' }
local one_bg3 = { '#3b3b3b' }
local orange = { '#a16946' }
local pink = { '#e1b2b0' }
local purple = { '#ba8baf' }
local red = { '#ab4642' }
local rosewater = { '#e9cac9' }
local sapphire = { '#75b2af' }
local statusline = { '#212121' }
local sun = { '#f7d8aa' }
local teal = { '#6cb598' }
local vibrant_green = { '#abcb56' }
local white = { '#f8f8f8' }
local yellow = { '#f7ca88' }
-- stylua: ignore end
