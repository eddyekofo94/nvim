...
vim.cmd.hi('clear')
vim.g.colors_name = 'sunrise_breeze'

-- stylua: ignore start
local baby_pink = { '#bc7a7c' }
local black = { '#f5f5f5' }
local black2 = { '#e0e0e0' }
local blue = { '#0969da' }
local cyan = { '#2c9ab7' }
local dark_purple = { '#6f4ecf' }
local darker_black = { '#ebebeb' }
local folder_bg = { '#68727d' }
local green = { '#238636' }
local grey = { '#9ea7b1' }
local grey_fg = { '#6e7681' }
local grey_fg2 = { '#8b949e' }
local lavender = { '#6341a7' }
local light_grey = { '#5c6166' }
local line = { '#e0e0e0' }
local maroon = { '#ca999f' }
local nord_blue = { '#4c85c8' }
local one_bg = { '#f5f5f5' }
local one_bg2 = { '#ececec' }
local one_bg3 = { '#e5e5e5' }
local orange = { '#d9822b' }
local pink = { '#f29999' }
local purple = { '#8250df' }
local red = { '#d64545' }
local rosewater = { '#a76e70' }
local sapphire = { '#197fca' }
local statusline = { '#e7e7e7' }
local sun = { '#8b6311' }
local teal = { '#2c9ab7' }
local vibrant_green = { '#2ea043' }
local white = { '#1b1f23' }
local yellow = { '#bb8009' }
-- stylua: ignore end
