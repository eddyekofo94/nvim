...
-- stylua: ignore start
local baby_pink = { '#795b79' }
local black = { '#e0e0e0' }
local black2 = { '#d0d0d0' }
local blue = { '#5F87AE' }
local cyan = { '#008787' }
local dark_purple = { '#875F87' }
local darker_black = { '#d7d7d7' }
local folder_bg = { '#6a6a6a' }
local green = { '#5F885F' }
local grey = { '#b0b0b0' }
local grey_fg = { '#a8a8a8' }
local grey_fg2 = { '#a0a0a0' }
local lavender = { '#765a76' }
local light_grey = { '#989898' }
local line = { '#c8c8c8' }
local maroon = { '#7f6787' }
local nord_blue = { '#8399af' }
local one_bg = { '#c8c8c8' }
local one_bg2 = { '#c0c0c0' }
local one_bg3 = { '#b8b8b8' }
local orange = { '#AF8760' }
local pink = { '#875F87' }
local purple = { '#875F87' }
local red = { '#AF5F5F' }
local rosewater = { '#735973' }
local sapphire = { '#5f879c' }
local statusline = { '#D8D8D8' }
local sun = { '#92765b' }
local teal = { '#5F8787' }
local vibrant_green = { '#93B2B2' }
local white = { '#4e4e4e' }
local yellow = { '#AF8760' }
-- stylua: ignore end
