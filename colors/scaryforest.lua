...
-- stylua: ignore start
local baby_pink = { '#cea8c0' }
local black = { '#121f1d' }
local black2 = { '#182724' }
local blue = { '#77beb4' }
local cyan = { '#7ebdae' }
local dark_purple = { '#7f9279' }
local darker_black = { '#0d1917' }
local folder_bg = { '#77beb4' }
local green = { '#83aa7c' }
local grey = { '#3a4d47' }
local grey_fg = { '#455952' }
local grey_fg2 = { '#50645c' }
local lavender = { '#a4b4a2' }
local light_grey = { '#5c7068' }
local line = { '#1c2926' }
local maroon = { '#bc9bb3' }
local nord_blue = { '#5c8b83' }
local one_bg = { '#1d2b28' }
local one_bg2 = { '#243531' }
local one_bg3 = { '#2b3e39' }
local orange = { '#c2a97d' }
local pink = { '#c993b5' }
local purple = { '#8c9f87' }
local red = { '#3ec195' }
local rosewater = { '#d0b0c4' }
local sapphire = { '#7fbeb0' }
local statusline = { '#162420' }
local sun = { '#c9c19f' }
local teal = { '#88bdaa' }
local vibrant_green = { '#78b573' }
local white = { '#dde5e0' }
local yellow = { '#c0b283' }
-- stylua: ignore end
