...
local folder_bg = { '#7A8A92' }
local green = { '#B5CEA8' }
local grey = { '#444444' }
local grey_fg = { '#4e4e4e' }
local grey_fg2 = { '#585858' }
local lavender = { '#cda4ec' }
local light_grey = { '#626262' }
local line = { '#2e2e2e' }
local maroon = { '#a381bc' }
local nord_blue = { '#4e7494' }
local one_bg = { '#282828' }
local one_bg2 = { '#313131' }
local one_bg3 = { '#3a3a3a' }
local orange = { '#d3967d' }
local pink = { '#bb7cb6' }
local purple = { '#c68aee' }
local red = { '#D16969' }
local rosewater = { '#c79fc7' }
local sapphire = { '#4d98d6' }
local statusline = { '#242424' }
local sun = { '#d9c69c' }
local teal = { '#4294D6' }
local vibrant_green = { '#bfd8b2' }
local white = { '#dee1e6' }
local yellow = { '#D7BA7D' }
-- stylua: ignore end
