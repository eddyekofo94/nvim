...
-- stylua: ignore start
local baby_pink = { '#f24084' }
local black = { '#121110' }
local black2 = { '#221f1e' }
local blue = { '#409cff' }
local cyan = { '#7fdbca' }
local dark_purple = { '#9280ff' }
local darker_black = { '#090908' }
local folder_bg = { '#7fdbca' }
local green = { '#92D923' }
local grey = { '#423b3a' }
local grey_fg = { '#4a4241' }
local grey_fg2 = { '#524948' }
local lavender = { '#b3a6fe' }
local light_grey = { '#5a504f' }
local line = { '#322d2c' }
local maroon = { '#be2571' }
local nord_blue = { '#4170a6' }
local one_bg = { '#2a2625' }
local one_bg2 = { '#322d2c' }
local one_bg3 = { '#3a3433' }
local orange = { '#f59762' }
local pink = { '#ed005c' }
local purple = { '#9380ff' }
local red = { '#ee7762' }
local rosewater = { '#f35994' }
local sapphire = { '#23a8e4' }
local statusline = { '#221f1e' }
local sun = { '#ffce4c' }
local teal = { '#00b7c3' }
local vibrant_green = { '#98dd2e' }
local white = { '#fffefd' }
local yellow = { '#ffb900' }
-- stylua: ignore end
