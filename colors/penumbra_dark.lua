...
-- stylua: ignore start
local baby_pink = { '#dc9eca' }
local black = { '#303338' }
local black2 = { '#3a3d42' }
local blue = { '#8C96EC' }
local cyan = { '#00B3C2' }
local dark_purple = { '#8C96EC' }
local darker_black = { '#2b2e33' }
local folder_bg = { '#8C96EC' }
local green = { '#4EB67F' }
local grey = { '#5c5f64' }
local grey_fg = { '#676a6f' }
local grey_fg2 = { '#72757a' }
local lavender = { '#c5a0d0' }
local light_grey = { '#7d8085' }
local line = { '#3E4044' }
local maroon = { '#a686bd' }
local nord_blue = { '#767daf' }
local one_bg = { '#3d4045' }
local one_bg2 = { '#484b50' }
local one_bg3 = { '#515459' }
local orange = { '#CE9042' }
local pink = { '#D07EBA' }
local purple = { '#ac78bd' }
local red = { '#CA7081' }
local rosewater = { '#e0aad1' }
local sapphire = { '#4d9ddc' }
local statusline = { '#34373c' }
local sun = { '#d4c580' }
local teal = { '#00a6c8' }
local vibrant_green = { '#50B584' }
local white = { '#FFFDFB' }
local yellow = { '#c1ad4b' }
-- stylua: ignore end
