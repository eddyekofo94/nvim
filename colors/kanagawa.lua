...
-- stylua: ignore start
local baby_pink = { '#cd8d9a' }
local black = { '#1F1F28' }
local black2 = { '#25252e' }
local blue = { '#7FB4CA' }
local cyan = { '#A3D4D5' }
local dark_purple = { '#9c86bf' }
local darker_black = { '#191922' }
local folder_bg = { '#7E9CD8' }
local green = { '#98BB6C' }
local grey = { '#43434c' }
local grey_fg = { '#4c4c55' }
local grey_fg2 = { '#53535c' }
local lavender = { '#b5a4c3' }
local light_grey = { '#5c5c65' }
local line = { '#31313a' }
local maroon = { '#b87e92' }
local nord_blue = { '#648191' }
local one_bg = { '#272730' }
local one_bg2 = { '#2f2f38' }
local one_bg3 = { '#363646' }
local orange = { '#fa9b61' }
local pink = { '#c8748f' }
local purple = { '#a48ec7' }
local red = { '#d8616b' }
local rosewater = { '#cf979e' }
local sapphire = { '#7dafb7' }
local statusline = { '#24242d' }
local sun = { '#f4af61' }
local teal = { '#7AA89F' }
local vibrant_green = { '#a3c677' }
local white = { '#DCD7BA' }
local yellow = { '#FF9E3B' }
-- stylua: ignore end
