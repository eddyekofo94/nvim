...
-- stylua: ignore start
local baby_pink = { '#c26094' }
local black = { '#2B2B2B' }
local black2 = { '#323232' }
local blue = { '#6FAFBD' }
local cyan = { '#00f1f5' }
local dark_purple = { '#b33076' }
local darker_black = { '#252525' }
local folder_bg = { '#6897BB' }
local green = { '#6A8759' }
local grey = { '#555555' }
local grey_fg = { '#646464' }
local grey_fg2 = { '#6b6b6b' }
local lavender = { '#b29abe' }
local light_grey = { '#727272' }
local line = { '#4c4c4c' }
local maroon = { '#a44584' }
local nord_blue = { '#63868e' }
local one_bg = { '#393939' }
local one_bg2 = { '#404040' }
local one_bg3 = { '#474747' }
local orange = { '#dc9656' }
local pink = { '#b33076' }
local purple = { '#9876AA' }
local red = { '#f43753' }
local rosewater = { '#c872a0' }
local sapphire = { '#6ca4bc' }
local statusline = { '#323232' }
local sun = { '#facf7c' }
local teal = { '#6897BB' }
local vibrant_green = { '#98be65' }
local white = { '#eeeeee' }
local yellow = { '#ffc24b' }
-- stylua: ignore end
