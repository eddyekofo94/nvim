...
-- stylua: ignore start
local baby_pink = { '#f0a7ab' }
local black = { '#1d1f21' }
local black2 = { '#232527' }
local blue = { '#6f8dab' }
local cyan = { '#70c0b1' }
local dark_purple = { '#b290ac' }
local darker_black = { '#191b1d' }
local folder_bg = { '#6f8dab' }
local green = { '#a4b595' }
local grey = { '#434547' }
local grey_fg = { '#545B68' }
local grey_fg2 = { '#616875' }
local lavender = { '#b9bfc6' }
local light_grey = { '#676e7b' }
local line = { '#313335' }
local maroon = { '#e8a3a7' }
local nord_blue = { '#5b6d7e' }
local one_bg = { '#2d2f31' }
...
local purple = { '#b4bbc8' }
local red = { '#cc6666' }
local rosewater = { '#ebabae' }
local sapphire = { '#7ba3b0' }
local statusline = { '#212326' }
local sun = { '#d2c09d' }
local teal = { '#8abdb6' }
local vibrant_green = { '#a3b991' }
local white = { '#C5C8C2' }
local yellow = { '#d7bd8d' }
-- stylua: ignore end
