...
-- stylua: ignore start
local baby_pink = { '#f489a2' }
local black = { '#2b3339' }
local black2 = { '#323a40' }
local blue = { '#7393b3' }
local cyan = { '#95d1c9' }
local dark_purple = { '#d699b6' }
local darker_black = { '#272f35' }
local folder_bg = { '#7393b3' }
local green = { '#83c092' }
local grey = { '#4e565c' }
local grey_fg = { '#545c62' }
local grey_fg2 = { '#626a70' }
local lavender = { '#e4b6c2' }
local light_grey = { '#656d73' }
local line = { '#3a4248' }
local maroon = { '#e17f9f' }
local nord_blue = { '#62788c' }
local one_bg = { '#363e44' }
local one_bg2 = { '#363e44' }
local one_bg3 = { '#3a4248' }
local orange = { '#e69875' }
local pink = { '#ff75a0' }
local purple = { '#ecafcc' }
local red = { '#e67e80' }
local rosewater = { '#f091a4' }
local sapphire = { '#6e9ba9' }
local statusline = { '#2e363c' }
local sun = { '#d9bf8c' }
local teal = { '#69a59d' }
local vibrant_green = { '#a7c080' }
local white = { '#D3C6AA' }
local yellow = { '#dbbc7f' }
-- stylua: ignore end
