...
-- stylua: ignore start
local baby_pink = { '#a76472' }
local black = { '#FFF7ED' }
local black2 = { '#f0e8de' }
local blue = { '#6E8DD5' }
local cyan = { '#00A0BA' }
local dark_purple = { '#806db8' }
local darker_black = { '#f5ede3' }
local folder_bg = { '#717171' }
local green = { '#3ea57b' }
local grey = { '#cec6bc' }
local grey_fg = { '#c4bcb2' }
local grey_fg2 = { '#bab2a8' }
local lavender = { '#8b6799' }
local light_grey = { '#b0a89e' }
local line = { '#ebe3d9' }
local maroon = { '#a87486' }
local nord_blue = { '#99a7ca' }
local one_bg = { '#F2E6D4' }
local one_bg2 = { '#e6ded4' }
local one_bg3 = { '#dad2c8' }
local orange = { '#BA823A' }
local pink = { '#CA7081' }
local purple = { '#ac78bd' }
local red = { '#ca7081' }
local rosewater = { '#995f6c' }
local sapphire = { '#4c88bb' }
local statusline = { '#f5ede3' }
local sun = { '#797c3d' }
local teal = { '#22839b' }
local vibrant_green = { '#46A473' }
local white = { '#3E4044' }
local yellow = { '#92963a' }
-- stylua: ignore end
