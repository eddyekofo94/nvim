...
vim.cmd.hi('clear')
vim.g.colors_name = 'obsidian-ember'

-- stylua: ignore start
local baby_pink = { '#d48e95' }
local black = { '#1e1e1e' }
local black2 = { '#252525' }
local blue = { '#eeeeee' }
local cyan = { '#00c3a5' }
local dark_purple = { '#bd5e91' }
local darker_black = { '#161616' }
local folder_bg = { '#cd6316' }
local green = { '#729cff' }
local grey = { '#414141' }
local grey_fg = { '#484848' }
local grey_fg2 = { '#4f4f4f' }
local lavender = { '#7b7b7b' }
local light_grey = { '#565656' }
local line = { '#333333' }
local maroon = { '#c17e99' }
local nord_blue = { '#a0a0a0' }
local one_bg = { '#2c2c2c' }
local one_bg2 = { '#333333' }
local one_bg3 = { '#3a3a3a' }
local orange = { '#cd6316' }
local pink = { '#d57780' }
local purple = { '#555555' }
local red = { '#ff6464' }
local rosewater = { '#d4979d' }
local sapphire = { '#b6c9f6' }
local statusline = { '#222222' }
local sun = { '#f2ce3f' }
local teal = { '#729cff' }
local vibrant_green = { '#76c793' }
local white = { '#d3d3d3' }
local yellow = { '#ffcc00' }
-- stylua: ignore end
