...
-- stylua: ignore start
local baby_pink = { '#9e5963' }
local black = { '#D8DEE9' }
local black2 = { '#c9cfda' }
local blue = { '#3f5f7f' }
local cyan = { '#6181a1' }
local dark_purple = { '#927dbd' }
local darker_black = { '#ced4df' }
local folder_bg = { '#616773' }
local green = { '#75905e' }
local grey = { '#a9afba' }
local grey_fg = { '#9fa5b0' }
local grey_fg2 = { '#959ba6' }
local lavender = { '#7a6d9d' }
local light_grey = { '#8b919c' }
local line = { '#acb2bd' }
local maroon = { '#a96472' }
local nord_blue = { '#6f839a' }
local one_bg = { '#c7cdd8' }
local one_bg2 = { '#bdc3ce' }
local one_bg3 = { '#b3b9c4' }
local orange = { '#b46b54' }
local pink = { '#c56770' }
local purple = { '#9c87c7' }
local red = { '#a3454e' }
local rosewater = { '#8f545e' }
local sapphire = { '#3c5c7c' }
local statusline = { '#ced4df' }
local sun = { '#946b13' }
local teal = { '#395979' }
local vibrant_green = { '#809b69' }
local white = { '#2a303c' }
local yellow = { '#c18401' }
-- stylua: ignore end
