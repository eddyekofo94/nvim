...
-- stylua: ignore start
local baby_pink = { '#c7a3b7' }
local black = { '#1c2023' }
local black2 = { '#24282b' }
local blue = { '#95aec7' }
local cyan = { '#9eb7d0' }
local dark_purple = { '#a58cbe' }
local darker_black = { '#161a1d' }
local folder_bg = { '#8ca5be' }
local green = { '#aec795' }
local grey = { '#44484b' }
local grey_fg = { '#4a4e51' }
local grey_fg2 = { '#515558' }
local lavender = { '#b6a6ca' }
local light_grey = { '#565a5d' }
local line = { '#303437' }
local maroon = { '#bc9baf' }
local nord_blue = { '#71808f' }
local one_bg = { '#272b2e' }
local one_bg2 = { '#303437' }
local one_bg3 = { '#3a3e41' }
local orange = { '#c7ae95' }
local pink = { '#c795ae' }
local purple = { '#ae95c7' }
local red = { '#c79595' }
local rosewater = { '#c7a8ba' }
local sapphire = { '#92b1bf' }
local statusline = { '#23272a' }
local sun = { '#c7c8a7' }
local teal = { '#8fb4b5' }
local vibrant_green = { '#95c7ae' }
local white = { '#c7ccd1' }
local yellow = { '#c7c795' }
-- stylua: ignore end
