...
-- stylua: ignore start
local baby_pink = { '#fd99d1' }
local black = { '#282A36' }
local black2 = { '#2d303e' }
local blue = { '#a1b1e3' }
local cyan = { '#8BE9FD' }
local dark_purple = { '#BD93F9' }
local darker_black = { '#222430' }
local folder_bg = { '#BD93F9' }
local green = { '#50fa7b' }
local grey = { '#5e5f69' }
local grey_fg = { '#666771' }
local grey_fg2 = { '#6e6f79' }
local lavender = { '#cfb1f7' }
local light_grey = { '#73747e' }
local line = { '#3c3d49' }
local maroon = { '#e981c9' }
local nord_blue = { '#838cac' }
local one_bg = { '#373844' }
local one_bg2 = { '#44475a' }
local one_bg3 = { '#565761' }
local orange = { '#FFB86C' }
local pink = { '#FF79C6' }
local purple = { '#BD93F9' }
local red = { '#ff7070' }
local rosewater = { '#fda5d5' }
local sapphire = { '#9aaadc' }
local statusline = { '#2d2f3b' }
local sun = { '#f3f9ab' }
local teal = { '#92a2d4' }
local vibrant_green = { '#5dff88' }
local white = { '#F8F8F2' }
local yellow = { '#F1FA8C' }
-- stylua: ignore end
