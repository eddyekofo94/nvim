...
-- stylua: ignore start
local baby_pink = { '#ffaaaa' }
local black = { '#111827' }
local black2 = { '#1a2130' }
local blue = { '#A5B4FC' }
local cyan = { '#BAE6FD' }
local dark_purple = { '#b3a6da' }
local darker_black = { '#0b1221' }
local folder_bg = { '#A5B4FC' }
local green = { '#B5E8B0' }
local grey = { '#3e4554' }
local grey_fg = { '#4a5160' }
local grey_fg2 = { '#545b6a' }
local lavender = { '#d1c8ec' }
local light_grey = { '#5f6675' }
local line = { '#282f3e' }
local maroon = { '#e3919c' }
local nord_blue = { '#7782b0' }
local one_bg = { '#1e2534' }
local one_bg2 = { '#282f3e' }
local one_bg3 = { '#323948' }
local orange = { '#FBC19D' }
local pink = { '#ff8e8e' }
local purple = { '#BDB0E4' }
local red = { '#FCA5A5' }
local rosewater = { '#ffb6b6' }
local sapphire = { '#8ea9ea' }
local statusline = { '#171e2d' }
local sun = { '#efe1c8' }
local teal = { '#719bd3' }
local vibrant_green = { '#B5E8B0' }
local white = { '#FFFFFF' }
local yellow = { '#E8D4B0' }
-- stylua: ignore end
