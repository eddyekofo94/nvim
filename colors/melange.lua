...
-- stylua: ignore start
local baby_pink = { '#c47d7e' }
local black = { '#2A2520' }
local black2 = { '#342f2a' }
local blue = { '#9AACCE' }
local cyan = { '#bbcdef' }
local dark_purple = { '#b570c6' }
local darker_black = { '#241f1a' }
local folder_bg = { '#697893' }
local green = { '#86A3A3' }
local grey = { '#57524d' }
local grey_fg = { '#605b56' }
local grey_fg2 = { '#6b6661' }
local lavender = { '#d09cd6' }
local light_grey = { '#75706b' }
local line = { '#39342f' }
local maroon = { '#a7626a' }
local nord_blue = { '#7c8494' }
local one_bg = { '#39342f' }
local one_bg2 = { '#433e39' }
local one_bg3 = { '#4d4843' }
local orange = { '#E49B5D' }
local pink = { '#B65C60' }
local purple = { '#c47fd5' }
local red = { '#B65C60' }
local rosewater = { '#c98b8a' }
local sapphire = { '#8495b3' }
local statusline = { '#312c27' }
local sun = { '#e6c487' }
local teal = { '#697893' }
local vibrant_green = { '#99D59D' }
local white = { '#ECE1D7' }
local yellow = { '#e3b865' }
-- stylua: ignore end
