...
- Simple & modular design
    ...
    - Manage each plugin in separate files under
      [`lua/pack/specs/start`](lua/my/pack/specs/start) or
      [`lua/pack/specs/opt`](lua/my/pack/specs/opt)
...
- [Pynvim](https://github.com/neovim/pynvim) for accessing some Python utility functions, e.g. [`shlex.split()`](https://docs.python.org/3/library/shlex.html#shlex.split), see `split()` in [`lua/utils/cmd.lua`](lua/my/utils/cmd.lua).
...
see [lua/configs/nvim-treesitter.lua](lua/my/configs/nvim-treesitter.lua).
...
This is already done in [lua/core/lsp.lua](lua/my/core/lsp.lua), where all LSP
...
2. [Configuration](#dap-configuration): configs for each language so that
   [lua/configs/nvim-dap.lua](lua/my/configs/nvim-dap.lua) knows how to launch
...
Configuration for each filetypes: [lua/configs/nvim-dap/dap](lua/my/configs/nvim-dap/dap).
...
[`lua/pack/specs/opt`](lua/my/pack/specs/opt) or
[`lua/pack/specs/start`](lua/my/pack/specs/start).

- Plugins specs under [`lua/pack/specs/start`](lua/my/pack/specs/start) will be
  required immediately on startup
- Plugins specs under [`lua/pack/specs/opt`](lua/my/pack/specs/opt) will be
...
[`lua/utils/load.lua`](lua/my/utils/load.lua) and
[`lua/utils/pack.lua`](lua/my/utils/pack.lua).
...
See [lua/core/opts.lua](lua/my/core/opts.lua).
...
See [lua/core/keymaps.lua](lua/my/core/keymaps.lua), or see [module config files](lua/my/configs) for
...
To disable the auto-restore feature, remove the `colorscheme_restore` augroup
in [lua/core/autocmds.lua](lua/my/core/autocmds.lua).

To tweak a colorscheme, edit corresponding colorscheme files under [colors](colors).

### Auto Commands

See [lua/core/autocmds.lua](lua/my/core/autocmds.lua).

### LSP Server Configurations

See
- [lua/plugin/lsp.lua](lua/my/plugin/lsp.lua) for custom lsp setups
...
See
- [lua/configs/nvim-dap/dap](lua/my/configs/nvim-dap/dap)
- [lua/configs/nvim-dap.lua](lua/my/configs/nvim-dap.lua)
- [lua/configs/nvim-dap-ui.lua](lua/my/configs/nvim-dap-ui.lua).
...
[lua/configs/luasnip/snippets](lua/my/configs/luasnip/snippets).
...
[lua/core/pack.lua](lua/my/core/pack.lua).
